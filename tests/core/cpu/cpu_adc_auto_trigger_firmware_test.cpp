...
TEST_CASE("ADC Auto-Trigger via Comparator Firmware Integration Test")
{
    ...
    bus.load_image(HexImage {
        .flash_words = {
            ...
            encode_sts(17U), atmega328p.adcs[0].adcsra_address, // 7, 8
            encode_lds(18U), atmega328p.adcs[0].adcsra_address, // 9, 10
            encode_lds(19U), atmega328p.adcs[0].adcsra_address, // 11, 12
            encode_lds(20U), atmega328p.adcs[0].adcsra_address, // 13, 14
