...
TEST_CASE("ADC External Interrupt Auto-Trigger Firmware Integration Test")
{
    ...
    bus.load_image(HexImage {
        .flash_words = {
            ...
            encode_sts(16U), atmega328p.ext_interrupts[0].eicra_address, // 7, 8
            encode_ldi(17U, 0xA0U),                     // 9 (ADEN | ADATE)
            encode_sts(17U), atmega328p.adcs[0].adcsra_address, // 10, 11
            encode_lds(18U), atmega328p.adcs[0].adcsra_address, // 12, 13
            encode_lds(19U), atmega328p.adcs[0].adcsra_address, // 14, 15
            encode_lds(20U), atmega328p.adcs[0].adcl_address,   // 16, 17
            encode_lds(21U), atmega328p.adcs[0].adch_address,   // 18, 19
            0x0000U
        },
        .entry_word = 0U
    });
