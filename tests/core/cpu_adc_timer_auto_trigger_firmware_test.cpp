...
TEST_CASE("ADC Timer Auto-Trigger Firmware Integrated Test")
{
    ...
    bus.load_image(HexImage {
        .flash_words = {
            ...
            encode_sts(17U), atmega328p.adcs[0].adcsrb_address, // 4, 5
            ...
            encode_sts(18U), atmega328p.adcs[0].adcsra_address, // 11, 12
            encode_lds(19U), atmega328p.adcs[0].adcsra_address, // 13, 14
            encode_lds(20U), atmega328p.adcs[0].adcl_address,   // 15, 16
            encode_lds(21U), atmega328p.adcs[0].adch_address,   // 17, 18
            0x0000U
        },
        .entry_word = 0U
    });
