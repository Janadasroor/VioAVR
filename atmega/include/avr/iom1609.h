...
typedef enum AC_MUXNEG_VALUES_enum
{
    ...
    AC_MUXNEG_PIN2_gv              = 0x02,  /* Negative Pin 2 */
...
typedef enum AC_MUXNEG_enum
{
    ...
    AC_MUXNEG_PIN2_gc              = (AC_MUXNEG_PIN2_gv << AC_MUXNEG_gp),  /* Negative Pin 2 */
...
typedef enum CCL_CLKSRC_VALUES_enum
{
    ...
    CCL_CLKSRC_OSC20M_gv           = 0x04,  /* 20MHz oscillator before prescaler is clocking the LUT */
    CCL_CLKSRC_OSCULP32K_gv        = 0x05,  /* 32kHz oscillator is clocking the LUT */
    CCL_CLKSRC_OSCULP1K_gv         = 0x06   /* 1kHz (32kHz oscillator after DIV32) is clocking the LUT */
} CCL_CLKSRC_values_t;

/* Clock Source Selection bit group configurations*/
typedef enum CCL_CLKSRC_enum
{
    CCL_CLKSRC_CLKPER_gc           = (CCL_CLKSRC_CLKPER_gv << CCL_CLKSRC_gp),  /* CLK_PER is clocking the LUT */
    CCL_CLKSRC_IN2_gc              = (CCL_CLKSRC_IN2_gv << CCL_CLKSRC_gp),  /* IN[2] is clocking the LUT */
    CCL_CLKSRC_OSC20M_gc           = (CCL_CLKSRC_OSC20M_gv << CCL_CLKSRC_gp),  /* 20MHz oscillator before prescaler is clocking the LUT */
    CCL_CLKSRC_OSCULP32K_gc        = (CCL_CLKSRC_OSCULP32K_gv << CCL_CLKSRC_gp),  /* 32kHz oscillator is clocking the LUT */
    CCL_CLKSRC_OSCULP1K_gc         = (CCL_CLKSRC_OSCULP1K_gv << CCL_CLKSRC_gp)   /* 1kHz (32kHz oscillator after DIV32) is clocking the LUT */
} CCL_CLKSRC_t;
...
typedef enum CCL_INSEL0_VALUES_enum
{
    ...
    CCL_INSEL0_TCB0_gv             = 0x0C   /* TCB0 WO input source */
} CCL_INSEL0_values_t;
...
typedef enum CCL_INSEL1_VALUES_enum
{
    ...
    CCL_INSEL1_TCB1_gv             = 0x0C   /* TCB1 WO input source */
} CCL_INSEL1_values_t;
...
typedef enum CCL_INSEL2_VALUES_enum
{
    ...
    CCL_INSEL2_TCB2_gv             = 0x0C   /* TCB2 WO input source */
} CCL_INSEL2_values_t;
...
typedef enum CCL_SEQSEL0_VALUES_enum
{
    CCL_SEQSEL0_DISABLE_gv         = 0x00,  /* Sequential logic disabled */
    CCL_SEQSEL0_DFF_gv             = 0x01,  /* D FlipFlop */
    CCL_SEQSEL0_JK_gv              = 0x02,  /* JK FlipFlop */
    CCL_SEQSEL0_LATCH_gv           = 0x03,  /* D Latch */
    CCL_SEQSEL0_RS_gv              = 0x04   /* RS Latch */
} CCL_SEQSEL0_values_t;

/* Sequential Selection bit group configurations*/
typedef enum CCL_SEQSEL0_enum
{
    CCL_SEQSEL0_DISABLE_gc         = (CCL_SEQSEL0_DISABLE_gv << CCL_SEQSEL0_gp),  /* Sequential logic disabled */
    CCL_SEQSEL0_DFF_gc             = (CCL_SEQSEL0_DFF_gv << CCL_SEQSEL0_gp),  /* D FlipFlop */
    CCL_SEQSEL0_JK_gc              = (CCL_SEQSEL0_JK_gv << CCL_SEQSEL0_gp),  /* JK FlipFlop */
    CCL_SEQSEL0_LATCH_gc           = (CCL_SEQSEL0_LATCH_gv << CCL_SEQSEL0_gp),  /* D Latch */
    CCL_SEQSEL0_RS_gc              = (CCL_SEQSEL0_RS_gv << CCL_SEQSEL0_gp)   /* RS Latch */
} CCL_SEQSEL0_t;

/* Sequential Selection bit group values */
typedef enum CCL_SEQSEL1_VALUES_enum
{
    CCL_SEQSEL1_DISABLE_gv         = 0x00,  /* Sequential logic disabled */
    CCL_SEQSEL1_DFF_gv             = 0x01,  /* D FlipFlop */
    CCL_SEQSEL1_JK_gv              = 0x02,  /* JK FlipFlop */
    CCL_SEQSEL1_LATCH_gv           = 0x03,  /* D Latch */
    CCL_SEQSEL1_RS_gv              = 0x04   /* RS Latch */
} CCL_SEQSEL1_values_t;

/* Sequential Selection bit group configurations*/
typedef enum CCL_SEQSEL1_enum
{
    CCL_SEQSEL1_DISABLE_gc         = (CCL_SEQSEL1_DISABLE_gv << CCL_SEQSEL1_gp),  /* Sequential logic disabled */
    CCL_SEQSEL1_DFF_gc             = (CCL_SEQSEL1_DFF_gv << CCL_SEQSEL1_gp),  /* D FlipFlop */
    CCL_SEQSEL1_JK_gc              = (CCL_SEQSEL1_JK_gv << CCL_SEQSEL1_gp),  /* JK FlipFlop */
    CCL_SEQSEL1_LATCH_gc           = (CCL_SEQSEL1_LATCH_gv << CCL_SEQSEL1_gp),  /* D Latch */
    CCL_SEQSEL1_RS_gc              = (CCL_SEQSEL1_RS_gv << CCL_SEQSEL1_gp)   /* RS Latch */
} CCL_SEQSEL1_t;
...
/* Channel selector bit group values */
typedef enum EVSYS_CHANNEL_VALUES_enum
{
    EVSYS_CHANNEL_OFF_gv           = 0x00,  /* Off */
    EVSYS_CHANNEL_CHANNEL0_gv      = 0x01,  /* Connect user to event channel 0 */
    EVSYS_CHANNEL_CHANNEL1_gv      = 0x02,  /* Connect user to event channel 1 */
    EVSYS_CHANNEL_CHANNEL2_gv      = 0x03,  /* Connect user to event channel 2 */
    EVSYS_CHANNEL_CHANNEL3_gv      = 0x04,  /* Connect user to event channel 3 */
    EVSYS_CHANNEL_CHANNEL4_gv      = 0x05,  /* Connect user to event channel 4 */
    EVSYS_CHANNEL_CHANNEL5_gv      = 0x06,  /* Connect user to event channel 5 */
    EVSYS_CHANNEL_CHANNEL6_gv      = 0x07,  /* Connect user to event channel 6 */
    EVSYS_CHANNEL_CHANNEL7_gv      = 0x08   /* Connect user to event channel 7 */
} EVSYS_CHANNEL_values_t;

/* Channel selector bit group configurations*/
typedef enum EVSYS_CHANNEL_enum
{
    EVSYS_CHANNEL_OFF_gc           = (EVSYS_CHANNEL_OFF_gv << EVSYS_CHANNEL_gp),  /* Off */
    EVSYS_CHANNEL_CHANNEL0_gc      = (EVSYS_CHANNEL_CHANNEL0_gv << EVSYS_CHANNEL_gp),  /* Connect user to event channel 0 */
    EVSYS_CHANNEL_CHANNEL1_gc      = (EVSYS_CHANNEL_CHANNEL1_gv << EVSYS_CHANNEL_gp),  /* Connect user to event channel 1 */
    EVSYS_CHANNEL_CHANNEL2_gc      = (EVSYS_CHANNEL_CHANNEL2_gv << EVSYS_CHANNEL_gp),  /* Connect user to event channel 2 */
    EVSYS_CHANNEL_CHANNEL3_gc      = (EVSYS_CHANNEL_CHANNEL3_gv << EVSYS_CHANNEL_gp),  /* Connect user to event channel 3 */
    EVSYS_CHANNEL_CHANNEL4_gc      = (EVSYS_CHANNEL_CHANNEL4_gv << EVSYS_CHANNEL_gp),  /* Connect user to event channel 4 */
    EVSYS_CHANNEL_CHANNEL5_gc      = (EVSYS_CHANNEL_CHANNEL5_gv << EVSYS_CHANNEL_gp),  /* Connect user to event channel 5 */
    EVSYS_CHANNEL_CHANNEL6_gc      = (EVSYS_CHANNEL_CHANNEL6_gv << EVSYS_CHANNEL_gp),  /* Connect user to event channel 6 */
    EVSYS_CHANNEL_CHANNEL7_gc      = (EVSYS_CHANNEL_CHANNEL7_gv << EVSYS_CHANNEL_gp)   /* Connect user to event channel 7 */
} EVSYS_CHANNEL_t;

/* Generator selector bit group values */
typedef enum EVSYS_GENERATOR_VALUES_enum
{
    EVSYS_GENERATOR_OFF_gv         = 0x00,  /* Off */
    EVSYS_GENERATOR_UPDI_gv        = 0x01,  /* Unified Program and Debug Interface */
    EVSYS_GENERATOR_RTC_OVF_gv     = 0x06,  /* Real Time Counter overflow */
    EVSYS_GENERATOR_RTC_CMP_gv     = 0x07,  /* Real Time Counter compare */
    EVSYS_GENERATOR_RTC_PIT0_gv    = 0x08,  /* Periodic Interrupt Timer output 0 */
    EVSYS_GENERATOR_RTC_PIT1_gv    = 0x09,  /* Periodic Interrupt Timer output 1 */
    EVSYS_GENERATOR_RTC_PIT2_gv    = 0x0A,  /* Periodic Interrupt Timer output 2 */
    EVSYS_GENERATOR_RTC_PIT3_gv    = 0x0B,  /* Periodic Interrupt Timer output 3 */
    EVSYS_GENERATOR_CCL_LUT0_gv    = 0x10,  /* Configurable Custom Logic LUT0 */
    EVSYS_GENERATOR_CCL_LUT1_gv    = 0x11,  /* Configurable Custom Logic LUT1 */
    EVSYS_GENERATOR_CCL_LUT2_gv    = 0x12,  /* Configurable Custom Logic LUT2 */
    EVSYS_GENERATOR_CCL_LUT3_gv    = 0x13,  /* Configurable Custom Logic LUT3 */
    EVSYS_GENERATOR_AC0_OUT_gv     = 0x20,  /* Analog Comparator 0 out */
    EVSYS_GENERATOR_ADC0_RESRDY_gv = 0x24,  /* ADC 0 Result Ready Event */
    EVSYS_GENERATOR_PORT0_PIN0_gv  = 0x40,  /* Port 0 Pin 0 */
    EVSYS_GENERATOR_PORT0_PIN1_gv  = 0x41,  /* Port 0 Pin 1 */
    EVSYS_GENERATOR_PORT0_PIN2_gv  = 0x42,  /* Port 0 Pin 2 */
    EVSYS_GENERATOR_PORT0_PIN3_gv  = 0x43,  /* Port 0 Pin 3 */
    EVSYS_GENERATOR_PORT0_PIN4_gv  = 0x44,  /* Port 0 Pin 4 */
    EVSYS_GENERATOR_PORT0_PIN5_gv  = 0x45,  /* Port 0 Pin 5 */
    EVSYS_GENERATOR_PORT0_PIN6_gv  = 0x46,  /* Port 0 Pin 6 */
    EVSYS_GENERATOR_PORT0_PIN7_gv  = 0x47,  /* Port 0 Pin 7 */
    EVSYS_GENERATOR_PORT1_PIN0_gv  = 0x48,  /* Port 1 Pin 0 */
    EVSYS_GENERATOR_PORT1_PIN1_gv  = 0x49,  /* Port 1 Pin 1 */
    EVSYS_GENERATOR_PORT1_PIN2_gv  = 0x4A,  /* Port 1 Pin 2 */
    EVSYS_GENERATOR_PORT1_PIN3_gv  = 0x4B,  /* Port 1 Pin 3 */
    EVSYS_GENERATOR_PORT1_PIN4_gv  = 0x4C,  /* Port 1 Pin 4 */
    EVSYS_GENERATOR_PORT1_PIN5_gv  = 0x4D,  /* Port 1 Pin 5 */
    EVSYS_GENERATOR_PORT1_PIN6_gv  = 0x4E,  /* Port 1 Pin 6 */
    EVSYS_GENERATOR_PORT1_PIN7_gv  = 0x4F,  /* Port 1 Pin 7 */
    EVSYS_GENERATOR_USART0_XCK_gv  = 0x60,  /* USART 0 Xclock */
    EVSYS_GENERATOR_USART1_XCK_gv  = 0x61,  /* USART 1 Xclock */
    EVSYS_GENERATOR_USART2_XCK_gv  = 0x62,  /* USART 2 Xclock */
    EVSYS_GENERATOR_USART3_XCK_gv  = 0x63,  /* USART 3 Xclock */
    EVSYS_GENERATOR_SPI0_SCK_gv    = 0x68,  /* SPI 0 Sclock */
    EVSYS_GENERATOR_TCA0_OVF_LUNF_gv = 0x80,  /* Timer/Counter A0 overflow / low byte underflow */
    EVSYS_GENERATOR_TCA0_HUNF_gv   = 0x81,  /* Timer/Counter A0 high byte underflow (split mode) */
    EVSYS_GENERATOR_TCA0_CMP0_gv   = 0x84,  /* Timer/Counter A0 compare 0 */
    EVSYS_GENERATOR_TCA0_CMP1_gv   = 0x85,  /* Timer/Counter A0 compare 1 */
    EVSYS_GENERATOR_TCA0_CMP2_gv   = 0x86,  /* Timer/Counter A0 compare 2 */
    EVSYS_GENERATOR_TCB0_CAPT_gv   = 0xA0,  /* Timer/Counter B0 capture */
    EVSYS_GENERATOR_TCB1_CAPT_gv   = 0xA2,  /* Timer/Counter B1 capture */
    EVSYS_GENERATOR_TCB2_CAPT_gv   = 0xA4,  /* Timer/Counter B2 capture */
    EVSYS_GENERATOR_TCB3_CAPT_gv   = 0xA6   /* Timer/Counter B3 capture */
} EVSYS_GENERATOR_values_t;

/* Generator selector bit group configurations*/
typedef enum EVSYS_GENERATOR_enum
{
    EVSYS_GENERATOR_OFF_gc         = (EVSYS_GENERATOR_OFF_gv << EVSYS_GENERATOR_gp),  /* Off */
    EVSYS_GENERATOR_UPDI_gc        = (EVSYS_GENERATOR_UPDI_gv << EVSYS_GENERATOR_gp),  /* Unified Program and Debug Interface */
    EVSYS_GENERATOR_RTC_OVF_gc     = (EVSYS_GENERATOR_RTC_OVF_gv << EVSYS_GENERATOR_gp),  /* Real Time Counter overflow */
    EVSYS_GENERATOR_RTC_CMP_gc     = (EVSYS_GENERATOR_RTC_CMP_gv << EVSYS_GENERATOR_gp),  /* Real Time Counter compare */
    EVSYS_GENERATOR_RTC_PIT0_gc    = (EVSYS_GENERATOR_RTC_PIT0_gv << EVSYS_GENERATOR_gp),  /* Periodic Interrupt Timer output 0 */
    EVSYS_GENERATOR_RTC_PIT1_gc    = (EVSYS_GENERATOR_RTC_PIT1_gv << EVSYS_GENERATOR_gp),  /* Periodic Interrupt Timer output 1 */
    EVSYS_GENERATOR_RTC_PIT2_gc    = (EVSYS_GENERATOR_RTC_PIT2_gv << EVSYS_GENERATOR_gp),  /* Periodic Interrupt Timer output 2 */
    EVSYS_GENERATOR_RTC_PIT3_gc    = (EVSYS_GENERATOR_RTC_PIT3_gv << EVSYS_GENERATOR_gp),  /* Periodic Interrupt Timer output 3 */
    EVSYS_GENERATOR_CCL_LUT0_gc    = (EVSYS_GENERATOR_CCL_LUT0_gv << EVSYS_GENERATOR_gp),  /* Configurable Custom Logic LUT0 */
    EVSYS_GENERATOR_CCL_LUT1_gc    = (EVSYS_GENERATOR_CCL_LUT1_gv << EVSYS_GENERATOR_gp),  /* Configurable Custom Logic LUT1 */
    EVSYS_GENERATOR_CCL_LUT2_gc    = (EVSYS_GENERATOR_CCL_LUT2_gv << EVSYS_GENERATOR_gp),  /* Configurable Custom Logic LUT2 */
    EVSYS_GENERATOR_CCL_LUT3_gc    = (EVSYS_GENERATOR_CCL_LUT3_gv << EVSYS_GENERATOR_gp),  /* Configurable Custom Logic LUT3 */
    EVSYS_GENERATOR_AC0_OUT_gc     = (EVSYS_GENERATOR_AC0_OUT_gv << EVSYS_GENERATOR_gp),  /* Analog Comparator 0 out */
    EVSYS_GENERATOR_ADC0_RESRDY_gc = (EVSYS_GENERATOR_ADC0_RESRDY_gv << EVSYS_GENERATOR_gp),  /* ADC 0 Result Ready Event */
    EVSYS_GENERATOR_PORT0_PIN0_gc  = (EVSYS_GENERATOR_PORT0_PIN0_gv << EVSYS_GENERATOR_gp),  /* Port 0 Pin 0 */
    EVSYS_GENERATOR_PORT0_PIN1_gc  = (EVSYS_GENERATOR_PORT0_PIN1_gv << EVSYS_GENERATOR_gp),  /* Port 0 Pin 1 */
    EVSYS_GENERATOR_PORT0_PIN2_gc  = (EVSYS_GENERATOR_PORT0_PIN2_gv << EVSYS_GENERATOR_gp),  /* Port 0 Pin 2 */
    EVSYS_GENERATOR_PORT0_PIN3_gc  = (EVSYS_GENERATOR_PORT0_PIN3_gv << EVSYS_GENERATOR_gp),  /* Port 0 Pin 3 */
    EVSYS_GENERATOR_PORT0_PIN4_gc  = (EVSYS_GENERATOR_PORT0_PIN4_gv << EVSYS_GENERATOR_gp),  /* Port 0 Pin 4 */
    EVSYS_GENERATOR_PORT0_PIN5_gc  = (EVSYS_GENERATOR_PORT0_PIN5_gv << EVSYS_GENERATOR_gp),  /* Port 0 Pin 5 */
    EVSYS_GENERATOR_PORT0_PIN6_gc  = (EVSYS_GENERATOR_PORT0_PIN6_gv << EVSYS_GENERATOR_gp),  /* Port 0 Pin 6 */
    EVSYS_GENERATOR_PORT0_PIN7_gc  = (EVSYS_GENERATOR_PORT0_PIN7_gv << EVSYS_GENERATOR_gp),  /* Port 0 Pin 7 */
    EVSYS_GENERATOR_PORT1_PIN0_gc  = (EVSYS_GENERATOR_PORT1_PIN0_gv << EVSYS_GENERATOR_gp),  /* Port 1 Pin 0 */
    EVSYS_GENERATOR_PORT1_PIN1_gc  = (EVSYS_GENERATOR_PORT1_PIN1_gv << EVSYS_GENERATOR_gp),  /* Port 1 Pin 1 */
    EVSYS_GENERATOR_PORT1_PIN2_gc  = (EVSYS_GENERATOR_PORT1_PIN2_gv << EVSYS_GENERATOR_gp),  /* Port 1 Pin 2 */
    EVSYS_GENERATOR_PORT1_PIN3_gc  = (EVSYS_GENERATOR_PORT1_PIN3_gv << EVSYS_GENERATOR_gp),  /* Port 1 Pin 3 */
    EVSYS_GENERATOR_PORT1_PIN4_gc  = (EVSYS_GENERATOR_PORT1_PIN4_gv << EVSYS_GENERATOR_gp),  /* Port 1 Pin 4 */
    EVSYS_GENERATOR_PORT1_PIN5_gc  = (EVSYS_GENERATOR_PORT1_PIN5_gv << EVSYS_GENERATOR_gp),  /* Port 1 Pin 5 */
    EVSYS_GENERATOR_PORT1_PIN6_gc  = (EVSYS_GENERATOR_PORT1_PIN6_gv << EVSYS_GENERATOR_gp),  /* Port 1 Pin 6 */
    EVSYS_GENERATOR_PORT1_PIN7_gc  = (EVSYS_GENERATOR_PORT1_PIN7_gv << EVSYS_GENERATOR_gp),  /* Port 1 Pin 7 */
    EVSYS_GENERATOR_USART0_XCK_gc  = (EVSYS_GENERATOR_USART0_XCK_gv << EVSYS_GENERATOR_gp),  /* USART 0 Xclock */
    EVSYS_GENERATOR_USART1_XCK_gc  = (EVSYS_GENERATOR_USART1_XCK_gv << EVSYS_GENERATOR_gp),  /* USART 1 Xclock */
    EVSYS_GENERATOR_USART2_XCK_gc  = (EVSYS_GENERATOR_USART2_XCK_gv << EVSYS_GENERATOR_gp),  /* USART 2 Xclock */
    EVSYS_GENERATOR_USART3_XCK_gc  = (EVSYS_GENERATOR_USART3_XCK_gv << EVSYS_GENERATOR_gp),  /* USART 3 Xclock */
    EVSYS_GENERATOR_SPI0_SCK_gc    = (EVSYS_GENERATOR_SPI0_SCK_gv << EVSYS_GENERATOR_gp),  /* SPI 0 Sclock */
    EVSYS_GENERATOR_TCA0_OVF_LUNF_gc = (EVSYS_GENERATOR_TCA0_OVF_LUNF_gv << EVSYS_GENERATOR_gp),  /* Timer/Counter A0 overflow / low byte underflow */
    EVSYS_GENERATOR_TCA0_HUNF_gc   = (EVSYS_GENERATOR_TCA0_HUNF_gv << EVSYS_GENERATOR_gp),  /* Timer/Counter A0 high byte underflow (split mode) */
    EVSYS_GENERATOR_TCA0_CMP0_gc   = (EVSYS_GENERATOR_TCA0_CMP0_gv << EVSYS_GENERATOR_gp),  /* Timer/Counter A0 compare 0 */
    EVSYS_GENERATOR_TCA0_CMP1_gc   = (EVSYS_GENERATOR_TCA0_CMP1_gv << EVSYS_GENERATOR_gp),  /* Timer/Counter A0 compare 1 */
    EVSYS_GENERATOR_TCA0_CMP2_gc   = (EVSYS_GENERATOR_TCA0_CMP2_gv << EVSYS_GENERATOR_gp),  /* Timer/Counter A0 compare 2 */
    EVSYS_GENERATOR_TCB0_CAPT_gc   = (EVSYS_GENERATOR_TCB0_CAPT_gv << EVSYS_GENERATOR_gp),  /* Timer/Counter B0 capture */
    EVSYS_GENERATOR_TCB1_CAPT_gc   = (EVSYS_GENERATOR_TCB1_CAPT_gv << EVSYS_GENERATOR_gp),  /* Timer/Counter B1 capture */
    EVSYS_GENERATOR_TCB2_CAPT_gc   = (EVSYS_GENERATOR_TCB2_CAPT_gv << EVSYS_GENERATOR_gp),  /* Timer/Counter B2 capture */
    EVSYS_GENERATOR_TCB3_CAPT_gc   = (EVSYS_GENERATOR_TCB3_CAPT_gv << EVSYS_GENERATOR_gp)   /* Timer/Counter B3 capture */
} EVSYS_GENERATOR_t;

/* Software event on channels select bit group values */
typedef enum EVSYS_STROBE0_VALUES_enum
{
    EVSYS_STROBE0_EV_STROBE_CH0_gv = 0x01,  /*  */
    EVSYS_STROBE0_EV_STROBE_CH1_gv = 0x02,  /*  */
    EVSYS_STROBE0_EV_STROBE_CH2_gv = 0x04,  /*  */
    EVSYS_STROBE0_EV_STROBE_CH3_gv = 0x08,  /*  */
    EVSYS_STROBE0_EV_STROBE_CH4_gv = 0x10,  /*  */
    EVSYS_STROBE0_EV_STROBE_CH5_gv = 0x20,  /*  */
    EVSYS_STROBE0_EV_STROBE_CH6_gv = 0x40,  /*  */
    EVSYS_STROBE0_EV_STROBE_CH7_gv = 0x80   /*  */
} EVSYS_STROBE0_values_t;

/* Software event on channels select bit group configurations*/
typedef enum EVSYS_STROBE0_enum
{
    EVSYS_STROBE0_EV_STROBE_CH0_gc = (EVSYS_STROBE0_EV_STROBE_CH0_gv << EVSYS_STROBE0_gp),  /*  */
    EVSYS_STROBE0_EV_STROBE_CH1_gc = (EVSYS_STROBE0_EV_STROBE_CH1_gv << EVSYS_STROBE0_gp),  /*  */
    EVSYS_STROBE0_EV_STROBE_CH2_gc = (EVSYS_STROBE0_EV_STROBE_CH2_gv << EVSYS_STROBE0_gp),  /*  */
    EVSYS_STROBE0_EV_STROBE_CH3_gc = (EVSYS_STROBE0_EV_STROBE_CH3_gv << EVSYS_STROBE0_gp),  /*  */
    EVSYS_STROBE0_EV_STROBE_CH4_gc = (EVSYS_STROBE0_EV_STROBE_CH4_gv << EVSYS_STROBE0_gp),  /*  */
    EVSYS_STROBE0_EV_STROBE_CH5_gc = (EVSYS_STROBE0_EV_STROBE_CH5_gv << EVSYS_STROBE0_gp),  /*  */
    EVSYS_STROBE0_EV_STROBE_CH6_gc = (EVSYS_STROBE0_EV_STROBE_CH6_gv << EVSYS_STROBE0_gp),  /*  */
    EVSYS_STROBE0_EV_STROBE_CH7_gc = (EVSYS_STROBE0_EV_STROBE_CH7_gv << EVSYS_STROBE0_gp)   /*  */
} EVSYS_STROBE0_t;
...
/* Event Output B select bit group values */
typedef enum PORTMUX_EVOUTB_VALUES_enum
{
    PORTMUX_EVOUTB_DEFAULT_gv      = 0x00   /* EVOUT on PB2 */
} PORTMUX_EVOUTB_values_t;

/* Event Output B select bit group configurations*/
typedef enum PORTMUX_EVOUTB_enum
{
    PORTMUX_EVOUTB_DEFAULT_gc      = (PORTMUX_EVOUTB_DEFAULT_gv << PORTMUX_EVOUTB_bp)   /* EVOUT on PB2 */
} PORTMUX_EVOUTB_t;
...
typedef enum PORTMUX_EVOUTC_VALUES_enum
{
    ...
    PORTMUX_EVOUTC_ALT1_gv         = 0x01   /* EVOUT on PC7 */
...
typedef enum PORTMUX_EVOUTC_enum
{
    ...
    PORTMUX_EVOUTC_ALT1_gc         = (PORTMUX_EVOUTC_ALT1_gv << PORTMUX_EVOUTC_bp)   /* EVOUT on PC7 */
} PORTMUX_EVOUTC_t;

/* Event Output D select bit group values */
typedef enum PORTMUX_EVOUTD_VALUES_enum
{
    PORTMUX_EVOUTD_DEFAULT_gv      = 0x00,  /* EVOUT on PD2 */
...
{
    PORTMUX_EVOUTD_DEFAULT_gc      = (PORTMUX_EVOUTD_DEFAULT_gv << PORTMUX_EVOUTD_bp),  /* EVOUT on PD2 */
    PORTMUX_EVOUTD_ALT1_gc         = (PORTMUX_EVOUTD_ALT1_gv << PORTMUX_EVOUTD_bp)   /* EVOUT on PD7 */
} PORTMUX_EVOUTD_t;

/* Event Output E select bit group values */
typedef enum PORTMUX_EVOUTE_VALUES_enum
{
    PORTMUX_EVOUTE_DEFAULT_gv      = 0x00   /* EVOUT on PE2 */
} PORTMUX_EVOUTE_values_t;

/* Event Output E select bit group configurations*/
typedef enum PORTMUX_EVOUTE_enum
{
    PORTMUX_EVOUTE_DEFAULT_gc      = (PORTMUX_EVOUTE_DEFAULT_gv << PORTMUX_EVOUTE_bp)   /* EVOUT on PE2 */
} PORTMUX_EVOUTE_t;

/* Event Output F select bit group values */
typedef enum PORTMUX_EVOUTF_VALUES_enum
{
    PORTMUX_EVOUTF_DEFAULT_gv      = 0x00   /* EVOUT on PF2 */
} PORTMUX_EVOUTF_values_t;

/* Event Output F select bit group configurations*/
typedef enum PORTMUX_EVOUTF_enum
{
    PORTMUX_EVOUTF_DEFAULT_gc      = (PORTMUX_EVOUTF_DEFAULT_gv << PORTMUX_EVOUTF_bp)   /* EVOUT on PF2 */
} PORTMUX_EVOUTF_t;

/* Port Multiplexer SPI0 select bit group values */
typedef enum PORTMUX_SPI0_VALUES_enum
{
    PORTMUX_SPI0_DEFAULT_gv        = 0x00,  /* SPI0 on PA[7:4] */
    PORTMUX_SPI0_ALT1_gv           = 0x01,  /* SPI0 on PC[3:0] */
    PORTMUX_SPI0_ALT2_gv           = 0x02,  /* SPI0 on PE[3:0] */
    PORTMUX_SPI0_NONE_gv           = 0x03   /* Not connected to any pins */
} PORTMUX_SPI0_values_t;

/* Port Multiplexer SPI0 select bit group configurations*/
typedef enum PORTMUX_SPI0_enum
{
    PORTMUX_SPI0_DEFAULT_gc        = (PORTMUX_SPI0_DEFAULT_gv << PORTMUX_SPI0_gp),  /* SPI0 on PA[7:4] */
    PORTMUX_SPI0_ALT1_gc           = (PORTMUX_SPI0_ALT1_gv << PORTMUX_SPI0_gp),  /* SPI0 on PC[3:0] */
    PORTMUX_SPI0_ALT2_gc           = (PORTMUX_SPI0_ALT2_gv << PORTMUX_SPI0_gp),  /* SPI0 on PE[3:0] */
    PORTMUX_SPI0_NONE_gc           = (PORTMUX_SPI0_NONE_gv << PORTMUX_SPI0_gp)   /* Not connected to any pins */
} PORTMUX_SPI0_t;

/* Port Multiplexer TCA0 select bit group values */
typedef enum PORTMUX_TCA0_VALUES_enum
{
    PORTMUX_TCA0_PORTA_gv          = 0x00,  /* TCA0 pins on PA[5:0] */
    PORTMUX_TCA0_PORTB_gv          = 0x01,  /* TCA0 pins on PB[5:0] */
    PORTMUX_TCA0_PORTC_gv          = 0x02,  /* TCA0 pins on PC[5:0] */
    PORTMUX_TCA0_PORTD_gv          = 0x03,  /* TCA0 pins on PD[5:0] */
    PORTMUX_TCA0_PORTE_gv          = 0x04,  /* TCA0 pins on PE[5:0] */
    PORTMUX_TCA0_PORTF_gv          = 0x05   /* TCA0 pins on PF[5:0] */
} PORTMUX_TCA0_values_t;

/* Port Multiplexer TCA0 select bit group configurations*/
typedef enum PORTMUX_TCA0_enum
{
    PORTMUX_TCA0_PORTA_gc          = (PORTMUX_TCA0_PORTA_gv << PORTMUX_TCA0_gp),  /* TCA0 pins on PA[5:0] */
    PORTMUX_TCA0_PORTB_gc          = (PORTMUX_TCA0_PORTB_gv << PORTMUX_TCA0_gp),  /* TCA0 pins on PB[5:0] */
    PORTMUX_TCA0_PORTC_gc          = (PORTMUX_TCA0_PORTC_gv << PORTMUX_TCA0_gp),  /* TCA0 pins on PC[5:0] */
    PORTMUX_TCA0_PORTD_gc          = (PORTMUX_TCA0_PORTD_gv << PORTMUX_TCA0_gp),  /* TCA0 pins on PD[5:0] */
    PORTMUX_TCA0_PORTE_gc          = (PORTMUX_TCA0_PORTE_gv << PORTMUX_TCA0_gp),  /* TCA0 pins on PE[5:0] */
    PORTMUX_TCA0_PORTF_gc          = (PORTMUX_TCA0_PORTF_gv << PORTMUX_TCA0_gp)   /* TCA0 pins on PF[5:0] */
} PORTMUX_TCA0_t;
...
typedef enum PORTMUX_TCB0_VALUES_enum
{
    ...
    PORTMUX_TCB0_ALT1_gv           = 0x01   /* WO on PF4 */
...
typedef enum PORTMUX_TCB0_enum
{
    ...
    PORTMUX_TCB0_ALT1_gc           = (PORTMUX_TCB0_ALT1_gv << PORTMUX_TCB0_bp)   /* WO on PF4 */
} PORTMUX_TCB0_t;
...
typedef enum PORTMUX_TCB1_VALUES_enum
{
    ...
    PORTMUX_TCB1_ALT1_gv           = 0x01   /* WO on PF5 */
...
typedef enum PORTMUX_TCB1_enum
{
    ...
    PORTMUX_TCB1_ALT1_gc           = (PORTMUX_TCB1_ALT1_gv << PORTMUX_TCB1_bp)   /* WO on PF5 */
} PORTMUX_TCB1_t;

/* Port Multiplexer TCB2 select bit group values */
typedef enum PORTMUX_TCB2_VALUES_enum
{
    PORTMUX_TCB2_DEFAULT_gv        = 0x00,  /* WO on PC0 */
    PORTMUX_TCB2_ALT1_gv           = 0x01   /* WO on PB4 */
} PORTMUX_TCB2_values_t;

/* Port Multiplexer TCB2 select bit group configurations*/
typedef enum PORTMUX_TCB2_enum
{
    PORTMUX_TCB2_DEFAULT_gc        = (PORTMUX_TCB2_DEFAULT_gv << PORTMUX_TCB2_bp),  /* WO on PC0 */
    PORTMUX_TCB2_ALT1_gc           = (PORTMUX_TCB2_ALT1_gv << PORTMUX_TCB2_bp)   /* WO on PB4 */
} PORTMUX_TCB2_t;

/* Port Multiplexer TCB3 select bit group values */
typedef enum PORTMUX_TCB3_VALUES_enum
{
    PORTMUX_TCB3_DEFAULT_gv        = 0x00,  /* WO on PB5 */
    PORTMUX_TCB3_ALT1_gv           = 0x01   /* WO on PC1 */
} PORTMUX_TCB3_values_t;

/* Port Multiplexer TCB3 select bit group configurations*/
typedef enum PORTMUX_TCB3_enum
{
    PORTMUX_TCB3_DEFAULT_gc        = (PORTMUX_TCB3_DEFAULT_gv << PORTMUX_TCB3_bp),  /* WO on PB5 */
...
{
    PORTMUX_TWI0_DEFAULT_gv        = 0x00,  /* SCL/SDA on PA[3:2], Client mode on PC[3:2] in dual TWI mode */
    PORTMUX_TWI0_ALT1_gv           = 0x01,  /* SCL/SDA on PA[3:2], Client mode on PF[3:2] in dual TWI mode */
    PORTMUX_TWI0_ALT2_gv           = 0x02,  /* SCL/SDA on PC[3:2], Client mode on PF[3:2] in dual TWI mode */
    PORTMUX_TWI0_NONE_gv           = 0x03   /* Not connected to any pins */
} PORTMUX_TWI0_values_t;

/* Port Multiplexer TWI0 select bit group configurations*/
typedef enum PORTMUX_TWI0_enum
{
    PORTMUX_TWI0_DEFAULT_gc        = (PORTMUX_TWI0_DEFAULT_gv << PORTMUX_TWI0_gp),  /* SCL/SDA on PA[3:2], Client mode on PC[3:2] in dual TWI mode */
    PORTMUX_TWI0_ALT1_gc           = (PORTMUX_TWI0_ALT1_gv << PORTMUX_TWI0_gp),  /* SCL/SDA on PA[3:2], Client mode on PF[3:2] in dual TWI mode */
    PORTMUX_TWI0_ALT2_gc           = (PORTMUX_TWI0_ALT2_gv << PORTMUX_TWI0_gp),  /* SCL/SDA on PC[3:2], Client mode on PF[3:2] in dual TWI mode */
    PORTMUX_TWI0_NONE_gc           = (PORTMUX_TWI0_NONE_gv << PORTMUX_TWI0_gp)   /* Not connected to any pins */
} PORTMUX_TWI0_t;

/* Port Multiplexer USART0 select bit group values */
typedef enum PORTMUX_USART0_VALUES_enum
{
    PORTMUX_USART0_DEFAULT_gv      = 0x00,  /* USART0 on PA[3:0] */
    PORTMUX_USART0_ALT1_gv         = 0x01,  /* USART0 on PA[7:4] */
    PORTMUX_USART0_NONE_gv         = 0x03   /* Not connected to any pins */
} PORTMUX_USART0_values_t;

/* Port Multiplexer USART0 select bit group configurations*/
typedef enum PORTMUX_USART0_enum
{
    PORTMUX_USART0_DEFAULT_gc      = (PORTMUX_USART0_DEFAULT_gv << PORTMUX_USART0_gp),  /* USART0 on PA[3:0] */
    PORTMUX_USART0_ALT1_gc         = (PORTMUX_USART0_ALT1_gv << PORTMUX_USART0_gp),  /* USART0 on PA[7:4] */
    PORTMUX_USART0_NONE_gc         = (PORTMUX_USART0_NONE_gv << PORTMUX_USART0_gp)   /* Not connected to any pins */
} PORTMUX_USART0_t;

/* Port Multiplexer USART1 select bit group values */
typedef enum PORTMUX_USART1_VALUES_enum
{
    PORTMUX_USART1_DEFAULT_gv      = 0x00,  /* USART1 on PC[3:0] */
    PORTMUX_USART1_ALT1_gv         = 0x01,  /* USART1 on PC[7:4] */
    PORTMUX_USART1_NONE_gv         = 0x03   /* Not connected to any pins */
} PORTMUX_USART1_values_t;

/* Port Multiplexer USART1 select bit group configurations*/
typedef enum PORTMUX_USART1_enum
{
    PORTMUX_USART1_DEFAULT_gc      = (PORTMUX_USART1_DEFAULT_gv << PORTMUX_USART1_gp),  /* USART1 on PC[3:0] */
    PORTMUX_USART1_ALT1_gc         = (PORTMUX_USART1_ALT1_gv << PORTMUX_USART1_gp),  /* USART1 on PC[7:4] */
    PORTMUX_USART1_NONE_gc         = (PORTMUX_USART1_NONE_gv << PORTMUX_USART1_gp)   /* Not connected to any pins */
} PORTMUX_USART1_t;

/* Port Multiplexer USART2 select bit group values */
typedef enum PORTMUX_USART2_VALUES_enum
{
    PORTMUX_USART2_DEFAULT_gv      = 0x00,  /* USART2 on PF[3:0] */
    PORTMUX_USART2_ALT1_gv         = 0x01,  /* USART2 on PF[6:4] */
    PORTMUX_USART2_NONE_gv         = 0x03   /* Not connected to any pins */
} PORTMUX_USART2_values_t;

/* Port Multiplexer USART2 select bit group configurations*/
typedef enum PORTMUX_USART2_enum
{
    PORTMUX_USART2_DEFAULT_gc      = (PORTMUX_USART2_DEFAULT_gv << PORTMUX_USART2_gp),  /* USART2 on PF[3:0] */
    PORTMUX_USART2_ALT1_gc         = (PORTMUX_USART2_ALT1_gv << PORTMUX_USART2_gp),  /* USART2 on PF[6:4] */
    PORTMUX_USART2_NONE_gc         = (PORTMUX_USART2_NONE_gv << PORTMUX_USART2_gp)   /* Not connected to any pins */
} PORTMUX_USART2_t;

/* Port Multiplexer USART3 select bit group values */
typedef enum PORTMUX_USART3_VALUES_enum
{
    PORTMUX_USART3_DEFAULT_gv      = 0x00,  /* USART3 on PB[3:0] */
    PORTMUX_USART3_ALT1_gv         = 0x01,  /* USART3 on PB[5:4] */
    PORTMUX_USART3_NONE_gv         = 0x03   /* Not connected to any pins */
} PORTMUX_USART3_values_t;

/* Port Multiplexer USART3 select bit group configurations*/
typedef enum PORTMUX_USART3_enum
{
    PORTMUX_USART3_DEFAULT_gc      = (PORTMUX_USART3_DEFAULT_gv << PORTMUX_USART3_gp),  /* USART3 on PB[3:0] */
    PORTMUX_USART3_ALT1_gc         = (PORTMUX_USART3_ALT1_gv << PORTMUX_USART3_gp),  /* USART3 on PB[5:4] */
    PORTMUX_USART3_NONE_gc         = (PORTMUX_USART3_NONE_gv << PORTMUX_USART3_gp)   /* Not connected to any pins */
} PORTMUX_USART3_t;
...
/* AC0 reference select bit group values */
typedef enum VREF_AC0REFSEL_VALUES_enum
{
    VREF_AC0REFSEL_0V55_gv         = 0x00,  /* Voltage reference at 0.55V */
    VREF_AC0REFSEL_1V1_gv          = 0x01,  /* Voltage reference at 1.1V */
    VREF_AC0REFSEL_2V5_gv          = 0x02,  /* Voltage reference at 2.5V */
    VREF_AC0REFSEL_4V34_gv         = 0x03,  /* Voltage reference at 4.34V */
    VREF_AC0REFSEL_1V5_gv          = 0x04,  /* Voltage reference at 1.5V */
    VREF_AC0REFSEL_AVDD_gv         = 0x07   /* AVDD as Voltage reference */
} VREF_AC0REFSEL_values_t;

/* AC0 reference select bit group configurations*/
typedef enum VREF_AC0REFSEL_enum
{
    VREF_AC0REFSEL_0V55_gc         = (VREF_AC0REFSEL_0V55_gv << VREF_AC0REFSEL_gp),  /* Voltage reference at 0.55V */
    VREF_AC0REFSEL_1V1_gc          = (VREF_AC0REFSEL_1V1_gv << VREF_AC0REFSEL_gp),  /* Voltage reference at 1.1V */
    VREF_AC0REFSEL_2V5_gc          = (VREF_AC0REFSEL_2V5_gv << VREF_AC0REFSEL_gp),  /* Voltage reference at 2.5V */
    VREF_AC0REFSEL_4V34_gc         = (VREF_AC0REFSEL_4V34_gv << VREF_AC0REFSEL_gp),  /* Voltage reference at 4.34V */
    VREF_AC0REFSEL_1V5_gc          = (VREF_AC0REFSEL_1V5_gv << VREF_AC0REFSEL_gp),  /* Voltage reference at 1.5V */
    VREF_AC0REFSEL_AVDD_gc         = (VREF_AC0REFSEL_AVDD_gv << VREF_AC0REFSEL_gp)   /* AVDD as Voltage reference */
} VREF_AC0REFSEL_t;
