...
def parse_atdf(file_path):
    ...
    device_info = {
        ...
        'vectors': 0, 'vector_size': 2, 'adc': {}, 'timer0': {}, 'timer2': {}, 
    ...
    device_info['ext_interrupt'] = { 'eicra': fr(r'EICRA')['addr'], 'eimsk': fr(r'EIMSK|GIMSK|GICR')['addr'], 'eifr': fr(r'EIFR|GIFR')['addr'], 'vector': fv(r'INT0') }
