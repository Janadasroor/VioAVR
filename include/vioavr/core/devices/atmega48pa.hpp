...
inline constexpr DeviceDescriptor atmega48pa {
    ...
    .acs = {{ {
            ...
            .ain0_pin_address = 0x29U, .ain0_pin_bit = 6U, .ain1_pin_address = 0x29U, .ain1_pin_bit = 7U,
    ...
    .eeprom_count = 1U,
    .eeproms = {{ {
            .eecr_address = 0x3FU, .eedr_address = 0x40U, .eearl_address = 0x42U, .eearh_address = 0x42U,
            .vector_index = 22U
        } }},
