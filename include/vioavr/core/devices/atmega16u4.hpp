...
inline constexpr DeviceDescriptor atmega16u4 {
    .name = "ATmega16U4",
    .flash_words = 8192U, .sram_bytes = 1280U, .eeprom_bytes = 512U,
    .interrupt_vector_count = 43U, .interrupt_vector_size = 2U, .flash_page_size = 0x80U,
    ...
    .adc = { 
        ...
        .didr0_address = 0x7EU,
        .adc_pin_address = {{ 0x31U, 0x31U, 0x0U, 0x0U, 0x31U, 0x31U, 0x31U, 0x31U }},
        .adc_pin_bit = {{ 0U, 1U, 0U, 0U, 4U, 5U, 6U, 7U }},
    ...
    .ac = { 
        ...
        .ain0_pin_address = 0x2EU, .ain0_pin_bit = 6U,
    ...
    .pin_change_interrupt_1 = { .pcicr_address = 0x68U, .pcifr_address = 0x3BU, .pcmsk_address = 0x0U, .pcicr_enable_mask = 0x2U, .pcifr_flag_mask = 0x2U, .vector_index = 0U },
    ...
    .twi = { .twbr_address = 0xB8U, .twsr_address = 0xB9U, .twar_address = 0xBAU, .twdr_address = 0xBBU, .twcr_address = 0xBCU, .twamr_address = 0xBDU, .vector_index = 36U, .twint_mask = 0x80U, .twen_mask = 0x4U, .twie_mask = 0x1U, .twsto_mask = 0x10U, .twsta_mask = 0x20U, .twea_mask = 0x40U },
