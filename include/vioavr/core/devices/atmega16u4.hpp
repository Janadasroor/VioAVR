...
inline constexpr DeviceDescriptor atmega16u4 {
    ...
    .adcs = {{ {
            ...
            .didr0_address = 0x7EU,
            .adc_pin_address = {{ 0x31U, 0x31U, 0x0U, 0x0U, 0x31U, 0x31U, 0x31U, 0x31U, 0x2BU, 0x2BU, 0x2BU, 0x25U, 0x25U, 0x25U, 0x0U, 0x0U }},
    ...
    .acs = {{ {
            ...
            .ain0_pin_address = 0x2EU, .ain0_pin_bit = 6U, .ain1_pin_address = 0x0U, .ain1_pin_bit = 0U,
    ...
    .timers16 = {{ {
        ...
        },
        {
            ...
            .compare_b_vector_index = 0U,
            .overflow_vector_index = 0U,
            .ocra_pin_address = 0x28U, .ocra_pin_bit = 6U, .ocrb_pin_address = 0x0U, .ocrb_pin_bit = 0U,
            .icp_pin_address = 0x28U, .icp_pin_bit = 7U,
