...
inline constexpr DeviceDescriptor atmega32u2 {
    .name = "ATmega32U2",
    .flash_words = 16384U, .sram_bytes = 1024U, .eeprom_bytes = 1024U,
    ...
    .pradc_bit = 255U, .prusart0_bit = 255U, .prspi_bit = 2U, .prtwi_bit = 255U, .prtimer0_bit = 5U, .prtimer1_bit = 3U, .prtimer2_bit = 255U,
    ...
    .ac = { 
        ...
        .ain0_pin_address = 0x2BU, .ain0_pin_bit = 1U,
        .ain1_pin_address = 0x2BU, .ain1_pin_bit = 2U,
        .aci_mask = 0x10U, .acie_mask = 0x8U
    },
    .timer0 = { .tcnt_address = 0x46U, .ocra_address = 0x47U, .ocrb_address = 0x48U, .tifr_address = 0x35U, .timsk_address = 0x6EU, .tccra_address = 0x44U, .tccrb_address = 0x45U, .assr_address = 0x0U, .tccra_reset = 0x0U, .tccrb_reset = 0x0U, .assr_reset = 0x0U, .compare_a_vector_index = 19U, .compare_b_vector_index = 20U, .overflow_vector_index = 21U, .compare_a_enable_mask = 0x02U, .compare_b_enable_mask = 0x04U, .overflow_enable_mask = 0x01U, .t0_pin_address = 0x2BU, .t0_pin_bit = 7U, .ocra_pin_address = 0x25U, .ocra_pin_bit = 7U, .ocrb_pin_address = 0x2BU, .ocrb_pin_bit = 0U, .tosc1_pin_address = 0x0U, .tosc1_pin_bit = 0U, .tosc2_pin_address = 0x0U, .tosc2_pin_bit = 0U, .wgm0_mask = 0x3U, .wgm2_mask = 0x8U, .cs_mask = 0x7U },
    ...
    .timer1 = { .tcnt_address = 0x84U, .ocra_address = 0x88U, .ocrb_address = 0x8AU, .icr_address = 0x86U, .tifr_address = 0x36U, .timsk_address = 0x6FU, .tccra_address = 0x80U, .tccrb_address = 0x81U, .tccrc_address = 0x82U, .tccra_reset = 0x0U, .tccrb_reset = 0x0U, .tccrc_reset = 0x0U, .capture_vector_index = 14U, .compare_a_vector_index = 15U, .compare_b_vector_index = 16U, .overflow_vector_index = 18U, .capture_enable_mask = 0x20U, .compare_a_enable_mask = 0x02U, .compare_b_enable_mask = 0x04U, .overflow_enable_mask = 0x01U, .t1_pin_address = 0x25U, .t1_pin_bit = 4U, .icp1_pin_address = 0x28U, .icp1_pin_bit = 7U, .wgm10_mask = 0x3U, .wgm12_mask = 0x18U, .cs_mask = 0x7U, .ices1_mask = 0x40U, .icnc1_mask = 0x80U },
    ...
    .wdt = { .wdtcsr_address = 0x60U, .vector_index = 13U },
