...
inline constexpr DeviceDescriptor avr128db64 {
    .name = "AVR128DB64",
    .flash_words = 65536U,
    .sram_bytes = 16384U,
    .sram_start = 0x4000U,
    .eeprom_bytes = 0U,
    .interrupt_vector_count = 65U,
    ...
    .timers_tca = {{
        ...
        },
        {
            ...
            .luf_ovf_vector_index = 47U,
            .cmp0_vector_index = 49U,
            .cmp1_vector_index = 50U,
            .cmp2_vector_index = 51U,
            .hunf_vector_index = 48U,
        }
    }},
    ...
    .timers_tcb = {{
        ...
        {
            .ctrla_address = 0xB40U,
            .ctrlb_address = 0xB41U,
            .evctrl_address = 0xB44U,
            .intctrl_address = 0xB45U,
            .intflags_address = 0xB46U,
            .status_address = 0xB47U,
            .dbgctrl_address = 0xB48U,
            .temp_address = 0xB49U,
            .cnt_address = 0xB4AU,
            .ccmp_address = 0xB4CU,
            .vector_index = 61U,
    ...
    .uarts8x = {{
        ...
        {
            .ctrla_address = 0x865U,
            .ctrlb_address = 0x866U,
            .ctrlc_address = 0x867U,
            .ctrld_address = 0x86AU,
            .status_address = 0x864U,
            .baud_address = 0x868U,
            .rxdata_address = 0x860U,
            .txdata_address = 0x862U,
            .dbgctrl_address = 0x86BU,
            .evctrl_address = 0x86CU,
            .rx_vector_index = 53U,
            .tx_vector_index = 55U,
            .dre_vector_index = 54U,
            .txd_pin_address = 0x424U,
            .txd_pin_bit = 4U,
            .rxd_pin_address = 0x424U,
            .rxd_pin_bit = 5U,
            .index = 3U,
        },
        {
            .ctrla_address = 0x885U,
            .ctrlb_address = 0x886U,
            .ctrlc_address = 0x887U,
            .ctrld_address = 0x88AU,
            .status_address = 0x884U,
            .baud_address = 0x888U,
            .rxdata_address = 0x880U,
            .txdata_address = 0x882U,
            .dbgctrl_address = 0x88BU,
            .evctrl_address = 0x88CU,
            .rx_vector_index = 56U,
            .tx_vector_index = 58U,
            .dre_vector_index = 57U,
            .txd_pin_address = 0x484U,
            .txd_pin_bit = 4U,
            .rxd_pin_address = 0x484U,
            .rxd_pin_bit = 5U,
            .index = 4U,
        },
        {
            .ctrla_address = 0x8A5U,
            .ctrlb_address = 0x8A6U,
            .ctrlc_address = 0x8A7U,
            .ctrld_address = 0x8AAU,
            .status_address = 0x8A4U,
            .baud_address = 0x8A8U,
            .rxdata_address = 0x8A0U,
            .txdata_address = 0x8A2U,
            .dbgctrl_address = 0x8ABU,
            .evctrl_address = 0x8ACU,
            .rx_vector_index = 62U,
            .tx_vector_index = 64U,
            .dre_vector_index = 63U,
            .txd_pin_address = 0x4C4U,
            .txd_pin_bit = 4U,
            .rxd_pin_address = 0x4C4U,
            .rxd_pin_bit = 5U,
            .index = 5U,
        }
    }},
    ...
    .zcds = {{
        ...
        {
            .ctrla_address = 0x6C8U,
            .intctrl_address = 0x6CAU,
            .status_address = 0x6CBU,
            .vector_index = 52U,
        },
        {
            .ctrla_address = 0x6D0U,
            .intctrl_address = 0x6D2U,
            .status_address = 0x6D3U,
            .vector_index = 60U,
        }
    }},
    ...
    .opamps = {{
        ...
        {
            .ctrla_address = 0x720U,
            .ctrlb_address = 0x721U,
            .resctrl_address = 0x722U,
            .muxctrl_address = 0x723U,
        },
    }},
...
,
        { "PORTG", 0x4C8U, 0x4C0U, 0x4C4U,
          0x4C1U, 0x4C2U, 0x4C3U, 0x4C5U, 0x4C6U, 0x4C7U,
          0x00U, 0x4C9U, 0x0018U, 255U }
    }}
};
