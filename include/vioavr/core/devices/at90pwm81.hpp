...
inline constexpr DeviceDescriptor at90pwm81 {
    ...
    .adc_count = 1U,
    .adcs = {{ {
            .adcl_address = 0x0U, .adch_address = 0x0U, .adcsra_address = 0x26U, .adcsrb_address = 0x27U, .admux_address = 0x28U,
            .vector_index = 13U,
    ...
    .timer16_count = 1U,
    .timers16 = {{ {
            .tcnt_address = 0x5AU, .ocra_address = 0x0U, .ocrb_address = 0x0U, .icr_address = 0x8CU, .tifr_address = 0x22U, .timsk_address = 0x21U, .tccra_address = 0x0U, .tccrb_address = 0x8AU, .tccrc_address = 0x0U,
