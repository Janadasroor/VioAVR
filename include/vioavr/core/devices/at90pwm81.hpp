...
inline constexpr DeviceDescriptor at90pwm81 {
    ...
    .adc = { .adcl_address = 0x4CU, .adch_address = 0x4DU, .adcsra_address = 0x26U, .adcsrb_address = 0x27U, .admux_address = 0x28U, .vector_index = 13U, .adcsra_reset = 0x0U, .adcsrb_reset = 0x0U, .admux_reset = 0x0U },
