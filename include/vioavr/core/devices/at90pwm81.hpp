...
inline constexpr DeviceDescriptor at90pwm81 {
    ...
    .interrupt_vector_count = 20U, .interrupt_vector_size = 2U, .flash_page_size = 0x40U,
    .spl_address = 0x5DU, .sph_address = 0x5EU, .sreg_address = 0x5FU, .spmcsr_address = 0x57U,
    .prr_address = 0x86U, .prr0_address = 0x0U, .prr1_address = 0x0U, .smcr_address = 0x53U, .mcusr_address = 0x54U,
    .pradc_bit = 0U, .prusart0_bit = 255U, .prspi_bit = 2U, .prtwi_bit = 255U, .prtimer0_bit = 255U, .prtimer1_bit = 4U, .prtimer2_bit = 255U,
    ...
    .spi = { .spcr_address = 0x37U, .spsr_address = 0x38U, .spdr_address = 0x56U, .spcr_reset = 0x0U, .spsr_reset = 0x0U, .vector_index = 15U, .spe_mask = 0x40U, .spie_mask = 0x80U, .mstr_mask = 0x10U, .spif_mask = 0x80U, .wcol_mask = 0x40U, .sp2x_mask = 0x1U },
