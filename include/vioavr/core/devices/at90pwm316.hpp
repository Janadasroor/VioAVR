...
inline constexpr DeviceDescriptor at90pwm316 {
    ...
    .timers8 = {{ {
            ...
            .ocra_pin_address = 0x23U, .ocra_pin_bit = 7U, .ocrb_pin_address = 0x29U, .ocrb_pin_bit = 0U,
    ...
    .timers16 = {{ {
            ...
            .ocra_pin_address = 0x23U, .ocra_pin_bit = 6U, .ocrb_pin_address = 0x23U, .ocrb_pin_bit = 2U, .ocrc_pin_address = 0x0U, .ocrc_pin_bit = 0U,
