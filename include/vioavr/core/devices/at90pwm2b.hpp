...
inline constexpr DeviceDescriptor at90pwm2b {
    .name = "AT90PWM2B",
    .flash_words = 4096U, .sram_bytes = 512U, .eeprom_bytes = 512U,
    .interrupt_vector_count = 32U, .interrupt_vector_size = 2U, .flash_page_size = 0x40U,
    ...
    .adc = { 
        .adcl_address = 0x78U, .adch_address = 0x79U, .adcsra_address = 0x7AU, .adcsrb_address = 0x7BU, .admux_address = 0x7CU, .vector_index = 18U, .adcsra_reset = 0x0U, .adcsrb_reset = 0x0U, .admux_reset = 0x0U,
        .didr0_address = 0x7EU,
    ...
    .ext_interrupt = { .eicra_address = 0x69U, .eimsk_address = 0x3DU, .eifr_address = 0x3CU, .int0_vector_index = 10U, .int1_vector_index = 19U },
    ...
    .wdt = { .wdtcsr_address = 0x60U, .vector_index = 25U },
