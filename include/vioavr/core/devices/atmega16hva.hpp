...
inline constexpr DeviceDescriptor atmega16hva {
    .name = "ATmega16HVA",
    .flash_words = 8192U, .sram_bytes = 512U, .eeprom_bytes = 256U,
    ...
    .pradc_bit = 255U, .prusart0_bit = 255U, .prspi_bit = 3U, .prtwi_bit = 255U, .prtimer0_bit = 1U, .prtimer1_bit = 2U, .prtimer2_bit = 255U,
    ...
    .spi = { .spcr_address = 0x4CU, .spsr_address = 0x4DU, .spdr_address = 0x4EU, .spcr_reset = 0x0U, .spsr_reset = 0x0U, .vector_index = 15U, .spe_mask = 0x40U, .spie_mask = 0x80U, .mstr_mask = 0x10U, .spif_mask = 0x80U, .wcol_mask = 0x40U, .sp2x_mask = 0x1U },
