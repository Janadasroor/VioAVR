...
inline constexpr DeviceDescriptor atmega640 = {
    ...
    .interrupt_vector_count = 57,
    .interrupt_vector_size = 4U,
    .flash_page_size = 0x100U,
    .register_file_range = { 0x0U, 0x1FU },
    .io_range = { 0x20U, 0x1FFU },
    .extended_io_range = { 0x200U, 0x1FFU },
    .spl_address = 0x5DU,
    .sph_address = 0x5EU,
    .sreg_address = 0x5FU,
    ...
    .timers16 = {{ {
            ...
            .tifr_address = 0x3AU,
            .timsk_address = 0x73U,
            .tccra_address = 0x120U, 
            .tccrb_address = 0x121U, 
            .tccrc_address = 0x122U,
    ...
    .uarts = {{ {
            ...
            .udr_address = 0x136U, 
            .ucsra_address = 0x130U, .ucsrb_address = 0x131U, .ucsrc_address = 0x132U,
            .ubrrl_address = 0x0U, .ubrrh_address = 0x0U,
            .rx_vector_index = 54U, 
    ...
    .port_count = 11U,
    .ports = {{ { "PORTA", 0x20U, 0x21U, 0x22U }, { "PORTB", 0x23U, 0x24U, 0x25U }, { "PORTC", 0x26U, 0x27U, 0x28U }, { "PORTD", 0x29U, 0x2AU, 0x2BU }, { "PORTE", 0x2CU, 0x2DU, 0x2EU }, { "PORTF", 0x2FU, 0x30U, 0x31U }, { "PORTG", 0x32U, 0x33U, 0x34U }, { "PORTH", 0x100U, 0x101U, 0x102U }, { "PORTJ", 0x103U, 0x104U, 0x105U }, { "PORTK", 0x106U, 0x107U, 0x108U }, { "PORTL", 0x109U, 0x10AU, 0x10BU } }}
};
