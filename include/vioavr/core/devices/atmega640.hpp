...
inline constexpr DeviceDescriptor atmega640 {
    .name = "ATmega640",
    .flash_words = 32768U, .sram_bytes = 8192U, .eeprom_bytes = 4096U,
    ...
    .adc = { 
        ...
        .didr0_address = 0x7EU,
        .adc_pin_address = {{ 0x31U, 0x31U, 0x31U, 0x31U, 0x31U, 0x31U, 0x31U, 0x31U }},
    ...
    .uart0 = { .udr_address = 0xC6U, .ucsra_address = 0xC0U, .ucsrb_address = 0xC1U, .ucsrc_address = 0xC2U, .ubrrl_address = 0xC4U, .ubrrh_address = 0xC5U, .ucsra_reset = 0x0U, .ucsrb_reset = 0x0U, .ucsrc_reset = 0x0U, .rx_vector_index = 25U, .udre_vector_index = 26U, .tx_vector_index = 27U, .u2x0_mask = 0x2U, .rxc0_mask = 0x80U, .txc0_mask = 0x40U, .udre0_mask = 0x20U, .rxen0_mask = 0x10U, .txen0_mask = 0x8U, .rxcie0_mask = 0x80U, .txcie0_mask = 0x40U, .udrie0_mask = 0x20U },
    ...
    .spi = { .spcr_address = 0x4CU, .spsr_address = 0x4DU, .spdr_address = 0x4EU, .spcr_reset = 0x0U, .spsr_reset = 0x0U, .vector_index = 24U, .spe_mask = 0x40U, .spie_mask = 0x80U, .mstr_mask = 0x10U, .spif_mask = 0x80U, .wcol_mask = 0x40U, .sp2x_mask = 0x1U },
    .twi = { .twbr_address = 0xB8U, .twsr_address = 0xB9U, .twar_address = 0xBAU, .twdr_address = 0xBBU, .twcr_address = 0xBCU, .twamr_address = 0xBDU, .vector_index = 39U, .twint_mask = 0x80U, .twen_mask = 0x4U, .twie_mask = 0x1U, .twsto_mask = 0x10U, .twsta_mask = 0x20U, .twea_mask = 0x40U },
