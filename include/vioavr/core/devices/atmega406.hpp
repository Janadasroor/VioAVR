...
inline constexpr DeviceDescriptor atmega406 {
    ...
    .pradc_bit = 255U, .prusart0_bit = 255U, .prspi_bit = 255U, .prtwi_bit = 3U, .prtimer0_bit = 1U, .prtimer1_bit = 2U, .prtimer2_bit = 255U,
    ...
    .twi = { .twbr_address = 0xB8U, .twsr_address = 0xB9U, .twar_address = 0xBAU, .twdr_address = 0xBBU, .twcr_address = 0xBCU, .twamr_address = 0xBDU, .vector_index = 15U, .twint_mask = 0x80U, .twen_mask = 0x4U, .twie_mask = 0x1U, .twsto_mask = 0x10U, .twsta_mask = 0x20U, .twea_mask = 0x40U },
