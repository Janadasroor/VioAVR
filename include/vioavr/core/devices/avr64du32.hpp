...
inline constexpr DeviceDescriptor avr64du32 {
    .name = "AVR64DU32",
    .flash_words = 32768U,
    .sram_bytes = 8192U,
    .sram_start = 0x6000U,
    .eeprom_bytes = 0U,
    .interrupt_vector_count = 34U,
    ...
    .timers_tca = {{
        {
            ...
            .luf_ovf_vector_index = 10U,
            .cmp0_vector_index = 12U,
            .cmp1_vector_index = 13U,
            .cmp2_vector_index = 14U,
            .hunf_vector_index = 11U,
        }
    }},
    ...
    .clkctrl = {
        ...
        .oschfstatus_address = 0x6AU,
        .usbpllstatus_address = 0x85U,
    },
    ...
    .usbs8x = {{
        {
            .ctrla_address = 0xC00U,
            .ctrlb_address = 0xC01U,
            .busstate_address = 0xC02U,
            .addr_address = 0xC03U,
            .fifowp_address = 0xC04U,
            .fiforp_address = 0xC05U,
            .epptr_address = 0xC06U,
            .intctrla_address = 0xC08U,
            .intctrlb_address = 0xC09U,
            .intflagsa_address = 0xC0AU,
            .intflagsb_address = 0xC0BU,
        }
    }},

    .signature = { 0x1E, 0x96, 0x21 },
