...
inline constexpr DeviceDescriptor avr128da32s {
    .name = "AVR128DA32S",
    .flash_words = 65536U,
    .sram_bytes = 16384U,
    .sram_start = 0x4000U,
    ...
    .twis8x = {{
        {
            ...
            .master_vector_index = 17U,
            .slave_vector_index = 16U,
            .index = 0U,
        },
        {
