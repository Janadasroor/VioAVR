...
inline constexpr DeviceDescriptor atmega2564rfr2 {
    .name = "ATmega2564RFR2",
    .flash_words = 131072U, .sram_bytes = 32768U, .eeprom_bytes = 8192U,
    .interrupt_vector_count = 77U, .interrupt_vector_size = 4U, .flash_page_size = 0x100U,
