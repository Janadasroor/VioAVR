...
inline constexpr DeviceDescriptor atmega2564rfr2 {
    ...
    .extended_io_range = { 0x60U, 0x1FFU },
    ...
    .timers8 = {{ {
        ...
        },
        {
            ...
            .as2_mask = 0x20U, .exclk_mask = 0x80U, .tcn2ub_mask = 0x10U,
    ...
    .timers16 = {{ {
        ...
        },
        {
            ...
            .compare_a_trigger_source = AdcAutoTriggerSource::timer5_compare_a,
            .compare_b_trigger_source = AdcAutoTriggerSource::timer5_compare_b,
            .compare_c_trigger_source = AdcAutoTriggerSource::timer5_compare_c,
    ...
    .signature = { 0x1EU, 0xA8U, 0x3U },
    .fuses = { 0x62U, 0x99U, 0xFEU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU },
    .lockbit_reset = 0xFFU,
