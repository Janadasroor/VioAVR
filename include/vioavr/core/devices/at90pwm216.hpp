...
inline constexpr DeviceDescriptor at90pwm216 {
    ...
    .interrupt_vector_count = 32U, .interrupt_vector_size = 4U, .flash_page_size = 0x80U,
    ...
    .uart0 = { .udr_address = 0xC6U, .ucsra_address = 0xC0U, .ucsrb_address = 0xC1U, .ucsrc_address = 0xC2U, .ubrrl_address = 0x0U, .ubrrh_address = 0xC5U, .ucsra_reset = 0x0U, .ucsrb_reset = 0x0U, .ucsrc_reset = 0x0U, .rx_vector_index = 21U, .udre_vector_index = 22U, .tx_vector_index = 23U },
