...
inline constexpr DeviceDescriptor avr32la32 {
    .name = "AVR32LA32",
    .flash_words = 16384U,
    .sram_bytes = 2048U,
    .sram_start = 0x7800U,
    ...
    .acs8x = {{
        {
            ...
            .intctrl_address = 0x684U,
            .status_address = 0x686U,
        }
    }},
    ...
    .uarts8x = {{
        {
            .ctrla_address = 0x800U,
            .ctrlb_address = 0x801U,
            .ctrlc_address = 0x802U,
            .ctrld_address = 0x803U,
            .status_address = 0x80EU,
            .baud_address = 0x80AU,
            .rxdata_address = 0x810U,
            .txdata_address = 0x812U,
            .dbgctrl_address = 0x81FU,
            .evctrl_address = 0x809U,
            .rx_vector_index = 18U,
            .tx_vector_index = 20U,
