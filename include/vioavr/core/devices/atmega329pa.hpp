...
inline constexpr DeviceDescriptor atmega329pa {
    ...
    .uart0 = { .udr_address = 0xC6U, .ucsra_address = 0xC0U, .ucsrb_address = 0xC1U, .ucsrc_address = 0xC2U, .ucsra_reset = 0x0U, .ucsrb_reset = 0x0U, .ucsrc_reset = 0x0U, .rx_vector_index = 13U, .udre_vector_index = 14U, .tx_vector_index = 15U },
