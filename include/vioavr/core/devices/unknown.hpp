...
inline constexpr DeviceDescriptor unknown {
    .name = "Unknown",
    .flash_words = 2048U, .sram_bytes = 2048U, .eeprom_bytes = 1024U,
    .interrupt_vector_count = 25U, .interrupt_vector_size = 2U,
    .adc = { .adcl_address = 0x0U, .adch_address = 0x0U, .adcsra_address = 0x7AU, .adcsrb_address = 0x7BU, .admux_address = 0x7CU, .vector_index = 19U },
    ...
    .eeprom = { .eecr_address = 0x3FU, .eedr_address = 0x40U, .eearl_address = 0x0U, .eearh_address = 0x0U, .vector_index = 20U },
