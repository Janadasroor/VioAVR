...
inline constexpr DeviceDescriptor atmega4808 {
    .name = "ATmega4808",
    .flash_words = 0U, .sram_bytes = 6144U, .eeprom_bytes = 256U,
    .interrupt_vector_count = 36U, .interrupt_vector_size = 2U, .flash_page_size = 0x0U,
    ...
    .twi = { .twbr_address = 0x0U, .twsr_address = 0x0U, .twar_address = 0x0U, .twdr_address = 0x0U, .twcr_address = 0x0U, .twamr_address = 0x0U, .vector_index = 14U, .twint_mask = 0x80U, .twen_mask = 0x4U, .twie_mask = 0x1U, .twsto_mask = 0x10U, .twsta_mask = 0x20U, .twea_mask = 0x40U },
