...
inline constexpr DeviceDescriptor atmega2561 {
    ...
    .interrupt_vector_count = 57U, .interrupt_vector_size = 2U,
    ...
    .uart0 = { .udr_address = 0xC6U, .ucsra_address = 0xC0U, .ucsrb_address = 0xC1U, .ucsrc_address = 0xC2U, .rx_vector_index = 25U, .udre_vector_index = 26U, .tx_vector_index = 27U },
