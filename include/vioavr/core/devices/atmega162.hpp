...
inline constexpr DeviceDescriptor atmega162 {
    ...
    .timer16_count = 2U,
    .timers16 = {{ {
            .tcnt_address = 0x4CU, .ocra_address = 0x4AU, .ocrb_address = 0x48U, .icr_address = 0x44U, .tifr_address = 0x58U, .timsk_address = 0x59U, .tccra_address = 0x4FU, .tccrb_address = 0x4EU, .tccrc_address = 0x0U,
        ...
        {
            .tcnt_address = 0x88U, .ocra_address = 0x86U, .ocrb_address = 0x84U, .icr_address = 0x80U, .tifr_address = 0x7CU, .timsk_address = 0x7DU, .tccra_address = 0x8BU, .tccrb_address = 0x8AU, .tccrc_address = 0x0U,
            .tccra_reset = 0x0U, .tccrb_reset = 0x0U, .tccrc_reset = 0x0U,
