...
inline constexpr DeviceDescriptor atmega162 {
    ...
    .uart0 = { .udr_address = 0x2CU, .ucsra_address = 0x2BU, .ucsrb_address = 0x2AU, .ucsrc_address = 0x40U, .ubrrl_address = 0x29U, .ubrrh_address = 0x40U, .ucsra_reset = 0x0U, .ucsrb_reset = 0x0U, .ucsrc_reset = 0x0U, .rx_vector_index = 19U, .udre_vector_index = 21U, .tx_vector_index = 23U },
    ...
    .spi = { .spcr_address = 0x2DU, .spsr_address = 0x2EU, .spdr_address = 0x2FU, .spcr_reset = 0x0U, .spsr_reset = 0x0U, .vector_index = 18U },
