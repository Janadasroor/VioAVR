...
inline constexpr DeviceDescriptor atmega162 {
    ...
    .timers16 = {{ {
        ...
        {
            .tcnt_address = 0x88U, .ocra_address = 0x86U, .ocrb_address = 0x84U, .ocrc_address = 0x0U, .icr_address = 0x80U, .tifr_address = 0x0U, .timsk_address = 0x0U, .tccra_address = 0x8BU, .tccrb_address = 0x8AU, .tccrc_address = 0x0U,
            .tccra_reset = 0x0U, .tccrb_reset = 0x0U, .tccrc_reset = 0x0U,
            .timer_index = 3U,
    ...
    .uarts = {{ {
        ...
        {
            .udr_address = 0x23U, .ucsra_address = 0x22U, .ucsrb_address = 0x21U, .ucsrc_address = 0x21U, .ubrrl_address = 0x0U, .ubrrh_address = 0x1U,
            .ucsra_reset = 0x0U, .ucsrb_reset = 0x0U, .ucsrc_reset = 0x0U,
            .rx_vector_index = 19U,
            .udre_vector_index = 21U,
            .tx_vector_index = 23U,
