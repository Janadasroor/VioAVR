...
inline constexpr DeviceDescriptor atmega8515 {
    ...
    .timer1 = { .tcnt_address = 0x4CU, .ocra_address = 0x4AU, .ocrb_address = 0x48U, .icr_address = 0x44U, .tifr_address = 0x58U, .timsk_address = 0x59U, .tccra_address = 0x4FU, .tccrb_address = 0x4EU, .tccrc_address = 0x0U, .capture_vector_index = 3U, .compare_a_vector_index = 4U, .compare_b_vector_index = 5U, .overflow_vector_index = 6U, .capture_enable_mask = 0x20U, .compare_a_enable_mask = 0x02U, .compare_b_enable_mask = 0x04U, .overflow_enable_mask = 0x01U },
    .ext_interrupt = { .eicra_address = 0x0U, .eimsk_address = 0x5BU, .eifr_address = 0x5AU, .int0_vector_index = 1U },
    .uart0 = { .udr_address = 0x2CU, .ucsra_address = 0x2BU, .ucsrb_address = 0x2AU, .ucsrc_address = 0x40U, .rx_vector_index = 9U, .udre_vector_index = 10U, .tx_vector_index = 11U },
    ...
    .spi = { .spcr_address = 0x2DU, .spsr_address = 0x2EU, .spdr_address = 0x2FU, .vector_index = 8U },
