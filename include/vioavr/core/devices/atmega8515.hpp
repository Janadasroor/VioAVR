...
inline constexpr DeviceDescriptor atmega8515 {
    ...
    .interrupt_vector_count = 17U, .interrupt_vector_size = 2U,
    ...
    .uart0 = { .udr_address = 0x2CU, .ucsra_address = 0x2BU, .ucsrb_address = 0x2AU, .ucsrc_address = 0x40U, .ucsra_reset = 0x0U, .ucsrb_reset = 0x0U, .ucsrc_reset = 0x0U, .rx_vector_index = 9U, .udre_vector_index = 10U, .tx_vector_index = 11U },
