...
inline constexpr DeviceDescriptor atmega8515 = {
    ...
    .timers8 = {{ {
            ...
            .compare_a_enable_mask = 0x0U, .compare_b_enable_mask = 0x0U, .overflow_enable_mask = 0x2U,
    ...
    .timers16 = {{ {
            ...
            .capture_enable_mask = 0x0U, .compare_a_enable_mask = 0x40U, .compare_b_enable_mask = 0x20U, .overflow_enable_mask = 0x80U,
            .pr_address = 0x0U, .pr_bit = 0xFFU
        } }},
    ...
    .port_count = 5U,
    .ports = {{ { "PORTA", 0x39U, 0x3AU, 0x3BU }, { "PORTB", 0x36U, 0x37U, 0x38U }, { "PORTC", 0x33U, 0x34U, 0x35U }, { "PORTD", 0x30U, 0x31U, 0x32U }, { "PORTE", 0x25U, 0x26U, 0x27U } }}
};
