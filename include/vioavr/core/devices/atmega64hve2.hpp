...
inline constexpr DeviceDescriptor atmega64hve2 {
    .name = "ATmega64HVE2",
    .flash_words = 4096U, .sram_bytes = 4096U, .eeprom_bytes = 1024U,
    ...
    .timer0 = { .tcnt_address = 0x46U, .ocra_address = 0x48U, .ocrb_address = 0x49U, .tifr_address = 0x35U, .timsk_address = 0x6EU, .tccra_address = 0x44U, .tccrb_address = 0x45U, .compare_a_vector_index = 11U, .compare_b_vector_index = 12U, .overflow_vector_index = 13U, .compare_a_enable_mask = 0x02U, .compare_b_enable_mask = 0x04U, .overflow_enable_mask = 0x01U },
    .timer1 = { .tcnt_address = 0x84U, .ocra_address = 0x88U, .ocrb_address = 0x89U, .icr_address = 0x0U, .tifr_address = 0x36U, .timsk_address = 0x6FU, .tccra_address = 0x80U, .tccrb_address = 0x81U, .tccrc_address = 0x0U, .capture_vector_index = 0U, .compare_a_vector_index = 7U, .compare_b_vector_index = 8U, .overflow_vector_index = 9U, .capture_enable_mask = 0x20U, .compare_a_enable_mask = 0x02U, .compare_b_enable_mask = 0x04U, .overflow_enable_mask = 0x01U },
    ...
    .spi = { .spcr_address = 0x4CU, .spsr_address = 0x4DU, .spdr_address = 0x4EU, .vector_index = 16U },
