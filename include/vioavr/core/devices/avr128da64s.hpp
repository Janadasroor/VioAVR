...
inline constexpr DeviceDescriptor avr128da64s {
    .name = "AVR128DA64S",
    .flash_words = 65536U,
    .sram_bytes = 16384U,
    .sram_start = 0x4000U,
    .eeprom_bytes = 0U,
    .interrupt_vector_count = 64U,
    ...
    .timers_tca = {{
        ...
        },
        {
            ...
            .luf_ovf_vector_index = 46U,
            .cmp0_vector_index = 48U,
            .cmp1_vector_index = 49U,
            .cmp2_vector_index = 50U,
            .hunf_vector_index = 47U,
        }
    }},
