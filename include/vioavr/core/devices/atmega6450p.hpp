...
inline constexpr DeviceDescriptor atmega6450p {
    .name = "ATmega6450P",
    .flash_words = 32768U, .sram_bytes = 4096U, .eeprom_bytes = 2048U,
    .interrupt_vector_count = 25U, .interrupt_vector_size = 4U, .flash_page_size = 0x100U,
    ...
    .pin_change_interrupt_2 = { .pcicr_address = 0x0U, .pcifr_address = 0x0U, .pcmsk_address = 0x6DU, .pcicr_enable_mask = 0x4U, .pcifr_flag_mask = 0x4U, .vector_index = 23U },
