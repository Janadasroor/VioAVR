...
inline constexpr DeviceDescriptor atmegas64m1 {
    ...
    .adcs = {{ {
            ...
            .didr0_address = 0x7EU,
            .adc_pin_address = {{ 0x2EU, 0x2BU, 0x2BU, 0x2BU, 0x25U, 0x25U, 0x25U, 0x25U, 0x28U, 0x28U, 0x28U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U }},
    ...
    .ac_count = 1U,
    .acs = {{ {
            .acsr_address = 0x50U, .didr1_address = 0x0U, .vector_index = 0U,
