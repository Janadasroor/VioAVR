...
inline constexpr DeviceDescriptor avr128db32 {
    .name = "AVR128DB32",
    .flash_words = 65536U,
    .sram_bytes = 16384U,
    .sram_start = 0x4000U,
    .eeprom_bytes = 0U,
    .interrupt_vector_count = 44U,
    ...
    .mapped_user_signatures = { 0x1080U, 0x0020U },
    ...
    .adcs8x = {{
        {
            ...
            .muxpos_address = 0x608U,
            .command_address = 0x60AU,
            .evctrl_address = 0x60BU,
            .intctrl_address = 0x60CU,
            .intflags_address = 0x60DU,
            .dbgctrl_address = 0x60EU,
            .temp_address = 0x60FU,
            .res_address = 0x610U,
    ...
    .timers_tca = {{
        {
            ...
            .luf_ovf_vector_index = 9U,
            .cmp0_vector_index = 11U,
            .cmp1_vector_index = 12U,
            .cmp2_vector_index = 13U,
            .hunf_vector_index = 10U,
        }
    }},
    ...
    .clkctrl = {
        ...
        .xoschfctrla_address = 0x80U,
        .mclkctrlc_address = 0x62U,
        .mclkintctrl_address = 0x63U,
        .mclkintflags_address = 0x64U,
    ...
    .mvio = {
        .intctrl_address = 0xC0U,
        .intflags_address = 0xC1U,
        .status_address = 0xC2U,
        .vector_index = 4U,
    },
    ...
    .twis8x = {{
        {
            ...
            .master_vector_index = 19U,
            .slave_vector_index = 18U,
            .index = 0U,
        },
        {
            .mctrla_address = 0x923U,
            .mctrlb_address = 0x924U,
            .mstatus_address = 0x925U,
            .mbaud_address = 0x926U,
            .maddr_address = 0x927U,
            .mdata_address = 0x928U,
            .sctrla_address = 0x929U,
            .sctrlb_address = 0x92AU,
            .sstatus_address = 0x92BU,
            .saddr_address = 0x92CU,
            .sdata_address = 0x92DU,
            .saddrmask_address = 0x92EU,
            .dbgctrl_address = 0x922U,
            .master_vector_index = 43U,
            .slave_vector_index = 42U,
            .index = 1U,
        }
    }},
