...
inline constexpr DeviceDescriptor atmega32 {
    ...
    .adcs = {{ {
            ...
            .didr0_address = 0x0U,
            .adc_pin_address = {{ 0x3BU, 0x3BU, 0x3BU, 0x3BU, 0x3BU, 0x3BU, 0x3BU, 0x3BU, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U }},
    ...
    .acs = {{ {
            ...
            .ain0_pin_address = 0x38U, .ain0_pin_bit = 2U, .ain1_pin_address = 0x38U, .ain1_pin_bit = 3U,
    ...
    .timers8 = {{ {
        ...
        },
        {
            ...
            .overflow_vector_index = 0U,
            .ocra_pin_address = 0x0U, .ocra_pin_bit = 0U, .ocrb_pin_address = 0x0U, .ocrb_pin_bit = 0U,
            .tosc1_pin_address = 0x35U, .tosc1_pin_bit = 6U, .tosc2_pin_address = 0x35U, .tosc2_pin_bit = 7U,
            .wgm0_mask = 0x0U, .wgm2_mask = 0x0U, .cs_mask = 0x0U,
    ...
    .timers16 = {{ {
            ...
            .compare_b_vector_index = 0U,
            .overflow_vector_index = 0U,
            .ocra_pin_address = 0x32U, .ocra_pin_bit = 5U, .ocrb_pin_address = 0x32U, .ocrb_pin_bit = 4U,
            .icp_pin_address = 0x32U, .icp_pin_bit = 6U,
