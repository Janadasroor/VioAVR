...
inline constexpr DeviceDescriptor at90usb1286 {
    ...
    .usb_count = 1U,
    .usbs = {{ {
            .uhwcon_address = 0x0U, .usbcon_address = 0x0U, .usbsta_address = 0x0U, .usbint_address = 0x0U,
    ...
    .signature = { 0x1EU, 0x97U, 0x82U },
    .fuses = { 0x5EU, 0x99U, 0xF3U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU },
