...
inline constexpr DeviceDescriptor atmegas128 {
    .name = "ATmegaS128",
    .flash_words = 65536U,
    .sram_bytes = 4096U,
    .eeprom_bytes = 4096U,
    ...
    .xmem = {
            ...
            .srl_mask = 112, .srw0_mask = 12, .srw1_mask = 2,
    ...
    .adcs = {{ {
            ...
            .adsc_mask = 0x40U, .adate_mask = 0x0U, .adif_mask = 0x10U, .adie_mask = 0x8U, .aden_mask = 0x80U, .adlar_mask = 0x20U,
            .adts_mask = 0x7U,
    ...
    .acs = {{ {
                ...
                .vector_index = 23U,
                .aip_pin_address = 0x21U, .aip_pin_bit = 2U, .aim_pin_address = 0x21U, .aim_pin_bit = 3U,
    ...
    .timers8 = {{ {
            ...
            .t_pin_address = 0x30U, .t_pin_bit = 7U,
        ...
        },
        {
            ...
            .tosc1_pin_address = 0x63U, .tosc1_pin_bit = 4U, .tosc2_pin_address = 0x63U, .tosc2_pin_bit = 3U,
            .wgm0_mask = 0x0U, .wgm2_mask = 0x0U, .cs_mask = 0x0U,
            .as2_mask = 0x0U, .exclk_mask = 0x0U, .tcn2ub_mask = 0x4U,
            .ocr2aub_mask = 0x0U, .ocr2bub_mask = 0x0U,
            .tcr2aub_mask = 0x0U, .tcr2bub_mask = 0x0U,
            .compare_a_enable_mask = 0x0U,
            .compare_b_enable_mask = 0x0U,
    ...
    .timer16_count = 2U,
    .timers16 = {{ {
            .tcnt_address = 0x4CU, .ocra_address = 0x4AU, .ocrb_address = 0x48U, .ocrc_address = 0x78U, .icr_address = 0x46U, .tifr_address = 0x56U, .timsk_address = 0x57U, .tccra_address = 0x4FU, .tccrb_address = 0x4EU, .tccrc_address = 0x7AU,
            ...
            .compare_c_vector_index = 24U,
            .overflow_vector_index = 14U,
            .ocra_pin_address = 0x38U, .ocra_pin_bit = 5U, .ocrb_pin_address = 0x38U, .ocrb_pin_bit = 6U, .ocrc_pin_address = 0x38U, .ocrc_pin_bit = 7U,
            .icp_pin_address = 0x30U, .icp_pin_bit = 4U,
            .t_pin_address = 0x30U, .t_pin_bit = 6U,
        ...
        {
            .tcnt_address = 0x88U, .ocra_address = 0x86U, .ocrb_address = 0x84U, .ocrc_address = 0x82U, .icr_address = 0x80U, .tifr_address = 0x0U, .timsk_address = 0x0U, .tccra_address = 0x8BU, .tccrb_address = 0x8AU, .tccrc_address = 0x8CU,
            .tccra_reset = 0x0U, .tccrb_reset = 0x0U, .tccrc_reset = 0x0U,
            .timer_index = 3U,
            .capture_vector_index = 25U,
            .compare_a_vector_index = 26U,
            .compare_b_vector_index = 27U,
            .compare_c_vector_index = 28U,
            .overflow_vector_index = 29U,
            .ocra_pin_address = 0x23U, .ocra_pin_bit = 3U, .ocrb_pin_address = 0x23U, .ocrb_pin_bit = 4U, .ocrc_pin_address = 0x23U, .ocrc_pin_bit = 5U,
            .icp_pin_address = 0x21U, .icp_pin_bit = 7U,
            .t_pin_address = 0x21U, .t_pin_bit = 6U,
            .wgm10_mask = 0x3U, .wgm12_mask = 0x18U, .cs_mask = 0x7U, .ices_mask = 0x40U, .icnc_mask = 0x80U,
    ...
    .uarts = {{ {
        ...
        {
            .udr_address = 0x9CU, .ucsra_address = 0x9BU, .ucsrb_address = 0x9AU, .ucsrc_address = 0x9AU, .ubrrl_address = 0x0U, .ubrrh_address = 0x1U,
            .ucsra_reset = 0x0U, .ucsrb_reset = 0x0U, .ucsrc_reset = 0x0U,
            .rx_vector_index = 0U,
            .udre_vector_index = 19U,
            .tx_vector_index = 0U,
    ...
    .signature = { 0x1EU, 0x97U, 0x2U },
    .fuses = { 0xE1U, 0x99U, 0xFDU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU },
