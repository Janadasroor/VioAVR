...
inline constexpr DeviceDescriptor atmegas128 = {
    .name = "ATmegaS128",
    .flash_words = 0x10000U,
    .sram_bytes = 0x1000U,
    .eeprom_bytes = 0x1000U,
    .interrupt_vector_count = 35,
    .interrupt_vector_size = 4U,
    .flash_page_size = 0x100U,
    ...
    .timers8 = {{ {
            ...
            .compare_a_enable_mask = 0x0U, .compare_b_enable_mask = 0x0U, .overflow_enable_mask = 0x40U,
            .pr_address = 0x0U, .pr_bit = 0xFFU
        } }},
    .timer16_count = 2U,
    .timers16 = {{ {
            ...
            .capture_enable_mask = 0x0U, .compare_a_enable_mask = 0x0U, .compare_b_enable_mask = 0x0U, .overflow_enable_mask = 0x0U,
            .pr_address = 0x0U, .pr_bit = 0xFFU
        } }},
    ...
    .uarts = {{ {
            .udr_address = 0x2CU, 
            .ucsra_address = 0x2BU, .ucsrb_address = 0x2AU, .ucsrc_address = 0x95U,
            .ubrrl_address = 0x29U, .ubrrh_address = 0x90U,
            .rx_vector_index = 18U, 
            ...
            .udr_address = 0x9CU, 
            .ucsra_address = 0x9BU, .ucsrb_address = 0x9AU, .ucsrc_address = 0x9DU,
            .ubrrl_address = 0x99U, .ubrrh_address = 0x98U,
            .rx_vector_index = 30U, 
    ...
    .port_count = 7U,
    .ports = {{ { "PORTA", 0x39U, 0x3AU, 0x3BU }, { "PORTB", 0x36U, 0x37U, 0x38U }, { "PORTC", 0x33U, 0x34U, 0x35U }, { "PORTD", 0x30U, 0x31U, 0x32U }, { "PORTE", 0x21U, 0x22U, 0x23U }, { "PORTF", 0x20U, 0x61U, 0x62U }, { "PORTG", 0x63U, 0x64U, 0x65U } }}
};
