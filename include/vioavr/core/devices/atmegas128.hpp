...
inline constexpr DeviceDescriptor atmegas128 {
    ...
    .timer0 = { .tcnt_address = 0x52U, .ocra_address = 0x51U, .ocrb_address = 0x0U, .tifr_address = 0x56U, .timsk_address = 0x57U, .tccra_address = 0x53U, .tccrb_address = 0x0U, .assr_address = 0x0U, .compare_a_vector_index = 15U, .compare_b_vector_index = 0U, .overflow_vector_index = 16U, .compare_a_enable_mask = 0x02U, .compare_b_enable_mask = 0x04U, .overflow_enable_mask = 0x01U },
    .timer2 = { .tcnt_address = 0x44U, .ocra_address = 0x43U, .ocrb_address = 0x0U, .tifr_address = 0x0U, .timsk_address = 0x0U, .tccra_address = 0x45U, .tccrb_address = 0x0U, .assr_address = 0x50U, .compare_a_vector_index = 9U, .compare_b_vector_index = 0U, .overflow_vector_index = 10U, .compare_a_enable_mask = 0x02U, .compare_b_enable_mask = 0x04U, .overflow_enable_mask = 0x01U },
