...
inline constexpr DeviceDescriptor atmega16a {
    ...
    .acs = {{ {
            ...
            .ain0_pin_address = 0x36U, .ain0_pin_bit = 2U, .ain1_pin_address = 0x36U, .ain1_pin_bit = 3U,
    ...
    .uart_count = 1U,
    .uarts = {{ {
            .udr_address = 0x2CU, .ucsra_address = 0x2BU, .ucsrb_address = 0x2AU, .ucsrc_address = 0x40U, .ubrrl_address = 0x29U, .ubrrh_address = 0x29U,
