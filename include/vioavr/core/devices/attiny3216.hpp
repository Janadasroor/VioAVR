...
inline constexpr DeviceDescriptor attiny3216 {
    .name = "ATtiny3216",
    .flash_words = 16384U,
    .sram_bytes = 2048U,
    .sram_start = 0x3800U,
    ...
    .mapped_user_signatures = { 0x1300U, 0x0040U },
    ...
    .adcs8x = {{
        {
            ...
            .res_ready_vector_index = 20U,
            .wcomp_vector_index = 21U,
        },
        {
            ...
            .sampctrl_address = 0x645U,
            .muxpos_address = 0x646U,
            .command_address = 0x648U,
            .evctrl_address = 0x649U,
            .intctrl_address = 0x64AU,
            .intflags_address = 0x64BU,
            .dbgctrl_address = 0x64CU,
            .calib_address = 0x656U,
            .temp_address = 0x64DU,
            .res_address = 0x650U,
            .winlt_address = 0x652U,
            .winht_address = 0x654U,
            .res_ready_vector_index = 22U,
            .wcomp_vector_index = 23U,
        }
    }},
    ...
    .timers_tcb = {{
        ...
        {
            .ctrla_address = 0xA50U,
            .ctrlb_address = 0xA51U,
            .evctrl_address = 0xA54U,
            .intctrl_address = 0xA55U,
            .intflags_address = 0xA56U,
            .status_address = 0xA57U,
            .dbgctrl_address = 0xA58U,
            .temp_address = 0xA59U,
            .cnt_address = 0xA5AU,
            .ccmp_address = 0xA5CU,
            .vector_index = 14U,
    ...
    .timers_tcd = {{
        {
            .base_address = 0x0A80U,
            .ovf_vector_index = 15U,
            .trig_vector_index = 16U,
        }
    }},
