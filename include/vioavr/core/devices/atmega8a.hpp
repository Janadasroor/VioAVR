...
inline constexpr DeviceDescriptor atmega8a {
    ...
    .adc_count = 1U,
    .adcs = {{ {
            .adcl_address = 0x0U, .adch_address = 0x0U, .adcsra_address = 0x26U, .adcsrb_address = 0x0U, .admux_address = 0x27U,
            .vector_index = 14U,
            .adcsra_reset = 0x0U, .adcsrb_reset = 0x0U, .admux_reset = 0x0U,
            .didr0_address = 0x0U,
            .adc_pin_address = {{ 0x35U, 0x35U, 0x35U, 0x35U, 0x35U, 0x35U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U }},
    ...
    .acs = {{ {
            ...
            .ain0_pin_address = 0x32U, .ain0_pin_bit = 6U, .ain1_pin_address = 0x32U, .ain1_pin_bit = 7U,
    ...
    .timer16_count = 1U,
    .timers16 = {{ {
            .tcnt_address = 0x4CU, .ocra_address = 0x4AU, .ocrb_address = 0x48U, .icr_address = 0x46U, .tifr_address = 0x58U, .timsk_address = 0x59U, .tccra_address = 0x4FU, .tccrb_address = 0x4EU, .tccrc_address = 0x0U,
            .tccra_reset = 0x0U, .tccrb_reset = 0x0U, .tccrc_reset = 0x0U,
            .capture_vector_index = 0U,
            .compare_a_vector_index = 0U,
            .compare_b_vector_index = 0U,
            .overflow_vector_index = 0U,
            .ocra_pin_address = 0x38U, .ocra_pin_bit = 1U, .ocrb_pin_address = 0x38U, .ocrb_pin_bit = 2U,
            .icp_pin_address = 0x38U, .icp_pin_bit = 0U,
