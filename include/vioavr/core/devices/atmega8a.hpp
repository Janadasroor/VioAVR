...
inline constexpr DeviceDescriptor atmega8a {
    ...
    .adcs = {{ {
            ...
            .didr0_address = 0x0U,
            .adc_pin_address = {{ 0x33U, 0x33U, 0x33U, 0x33U, 0x33U, 0x33U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U }},
    ...
    .acs = {{ {
                ...
                .vector_index = 0U,
                .aip_pin_address = 0x30U, .aip_pin_bit = 6U, .aim_pin_address = 0x30U, .aim_pin_bit = 7U,
    ...
    .timers8 = {{ {
            ...
            .t_pin_address = 0x30U, .t_pin_bit = 4U,
        ...
        },
        {
            ...
            .tosc1_pin_address = 0x0U, .tosc1_pin_bit = 0U, .tosc2_pin_address = 0x0U, .tosc2_pin_bit = 0U,
            .wgm0_mask = 0x0U, .wgm2_mask = 0x0U, .cs_mask = 0x0U,
            .as2_mask = 0x8U, .exclk_mask = 0x0U, .tcn2ub_mask = 0x4U,
            .ocr2aub_mask = 0x0U, .ocr2bub_mask = 0x0U,
            .tcr2aub_mask = 0x0U, .tcr2bub_mask = 0x0U,
            .compare_a_enable_mask = 0x0U,
            .compare_b_enable_mask = 0x0U,
    ...
    .timers16 = {{ {
            ...
            .ocra_pin_address = 0x38U, .ocra_pin_bit = 1U, .ocrb_pin_address = 0x38U, .ocrb_pin_bit = 2U, .ocrc_pin_address = 0x0U, .ocrc_pin_bit = 0U,
            .icp_pin_address = 0x36U, .icp_pin_bit = 0U,
            .t_pin_address = 0x30U, .t_pin_bit = 5U,
    ...
    .uarts = {{ {
            ...
            .pr_address = 0, .pr_bit = 255,
            .uart_index = 0U,
            .txd_pin_address = 0x32U, .txd_pin_bit = 1U,
            .rxd_pin_address = 0x30U, .rxd_pin_bit = 0U
        } }},
