...
inline constexpr DeviceDescriptor atmega324pb {
    ...
    .adcs = {{ {
            ...
            .didr0_address = 0x7EU,
            .adc_pin_address = {{ 0x22U, 0x22U, 0x22U, 0x22U, 0x22U, 0x22U, 0x22U, 0x22U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U }},
    ...
    .acs = {{ {
            ...
            .ain0_pin_address = 0x25U, .ain0_pin_bit = 2U, .ain1_pin_address = 0x25U, .ain1_pin_bit = 3U,
    ...
    .timers8 = {{ {
        ...
        },
        {
            ...
            .tosc1_pin_address = 0x28U, .tosc1_pin_bit = 6U, .tosc2_pin_address = 0x28U, .tosc2_pin_bit = 7U,
    ...
    .timers16 = {{ {
            ...
            .icp_pin_address = 0x2BU, .icp_pin_bit = 6U,
        ...
        },
        {
            ...
            .icp_pin_address = 0x25U, .icp_pin_bit = 5U,
        ...
        },
        {
            ...
            .icp_pin_address = 0x28U, .icp_pin_bit = 3U,
