...
inline constexpr DeviceDescriptor atmega324pb {
    ...
    .timers8 = {{ {
            ...
            .compare_b_vector_index = 17U,
            .overflow_vector_index = 18U,
            .ocra_pin_address = 0x25U, .ocra_pin_bit = 3U, .ocrb_pin_address = 0x25U, .ocrb_pin_bit = 4U,
            .t_pin_address = 0x23U, .t_pin_bit = 0U,
        ...
        },
        {
            ...
            .ocra_pin_address = 0x2BU, .ocra_pin_bit = 7U, .ocrb_pin_address = 0x2BU, .ocrb_pin_bit = 6U,
            .t_pin_address = 0x0U, .t_pin_bit = 0U,
            .tosc1_pin_address = 0x26U, .tosc1_pin_bit = 6U, .tosc2_pin_address = 0x26U, .tosc2_pin_bit = 7U,
            .wgm0_mask = 0x0U, .wgm2_mask = 0x8U, .cs_mask = 0x7U,
            .as2_mask = 0x20U, .exclk_mask = 0x40U, .tcn2ub_mask = 0x10U,
            .ocr2aub_mask = 0x8U, .ocr2bub_mask = 0x4U,
            .tcr2aub_mask = 0x2U, .tcr2bub_mask = 0x1U,
            .compare_a_enable_mask = 0x2U,
            .compare_b_enable_mask = 0x4U,
            .overflow_enable_mask = 0x1U,
            .foca_mask = 0x80U, .focb_mask = 0x40U,
    ...
    .timers16 = {{ {
            ...
            .ocra_pin_address = 0x2BU, .ocra_pin_bit = 5U, .ocrb_pin_address = 0x2BU, .ocrb_pin_bit = 4U, .ocrc_pin_address = 0x0U, .ocrc_pin_bit = 0U,
            .icp_pin_address = 0x29U, .icp_pin_bit = 6U,
            .t_pin_address = 0x23U, .t_pin_bit = 1U,
        ...
        },
        {
            ...
            .compare_c_vector_index = 0U,
            .overflow_vector_index = 34U,
            .ocra_pin_address = 0x25U, .ocra_pin_bit = 6U, .ocrb_pin_address = 0x25U, .ocrb_pin_bit = 7U, .ocrc_pin_address = 0x0U, .ocrc_pin_bit = 0U,
            .icp_pin_address = 0x23U, .icp_pin_bit = 5U,
            .t_pin_address = 0x29U, .t_pin_bit = 0U,
            .wgm10_mask = 0x3U, .wgm12_mask = 0x18U, .cs_mask = 0x7U, .ices_mask = 0x40U, .icnc_mask = 0x80U,
            .capture_enable_mask = 0x20U,
            .compare_a_enable_mask = 0x2U,
            .compare_b_enable_mask = 0x4U,
        ...
        },
        {
            ...
            .tccra_reset = 0x0U, .tccrb_reset = 0x0U, .tccrc_reset = 0x0U,
            .timer_index = 4U,
            .capture_vector_index = 43U,
            .compare_a_vector_index = 44U,
            .compare_b_vector_index = 45U,
            .compare_c_vector_index = 0U,
            .overflow_vector_index = 46U,
            .ocra_pin_address = 0x28U, .ocra_pin_bit = 4U, .ocrb_pin_address = 0x25U, .ocrb_pin_bit = 7U, .ocrc_pin_address = 0x0U, .ocrc_pin_bit = 0U,
            .icp_pin_address = 0x26U, .icp_pin_bit = 3U,
            ...
            .compare_c_trigger_source = AdcAutoTriggerSource::timer4_compare_c,
            .overflow_trigger_source = AdcAutoTriggerSource::timer4_overflow,
            .capture_trigger_source = AdcAutoTriggerSource::timer4_capture
        } }},
    .timer10_count = 0U,
    .timers10 = {{  }},
    .tca_count = 0U,
    ...
    .pcints = {{ {
        ...
        },
        {
            ...
            .pcifr_address = 0x3BU,
            .pcmsk_address = 0x75U,
            .pcicr_enable_mask = 0x10U, .pcifr_flag_mask = 0x10U,
            .vector_index = 37U
        } }},
    ...
    .spis = {{ {
            ...
            .spcr_reset = 0x0U, .spsr_reset = 0x0U, .vector_index = 19U,
    ...
    .signature = { 0x1EU, 0x95U, 0x17U },
    .fuses = { 0x62U, 0x99U, 0x7U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU },
