...
inline constexpr DeviceDescriptor atmega324pb = {
    ...
    .uarts = {{ {
            ...
            .udr_address = 0xCEU, 
            .ucsra_address = 0xC8U, .ucsrb_address = 0xC9U, .ucsrc_address = 0xCAU,
            .ubrrl_address = 0x0U, .ubrrh_address = 0x0U,
            .rx_vector_index = 28U, 
            ...
            .udr_address = 0xD6U, 
            .ucsra_address = 0xD0U, .ucsrb_address = 0xD1U, .ucsrc_address = 0xD2U,
            .ubrrl_address = 0x0U, .ubrrh_address = 0x0U,
            .rx_vector_index = 47U, 
    ...
    .port_count = 5U,
    .ports = {{ { "PORTA", 0x20U, 0x21U, 0x22U }, { "PORTB", 0x23U, 0x24U, 0x25U }, { "PORTC", 0x26U, 0x27U, 0x28U }, { "PORTD", 0x29U, 0x2AU, 0x2BU }, { "PORTE", 0x2CU, 0x2DU, 0x2EU } }}
};
