...
inline constexpr DeviceDescriptor atmega324pb {
    .name = "ATmega324PB",
    .flash_words = 16384U, .sram_bytes = 2048U, .eeprom_bytes = 1024U,
    .interrupt_vector_count = 51U, .interrupt_vector_size = 4U, .flash_page_size = 0x80U,
    ...
    .spi = { .spcr_address = 0x0U, .spsr_address = 0x0U, .spdr_address = 0x0U, .spcr_reset = 0x0U, .spsr_reset = 0x0U, .vector_index = 0U, .spe_mask = 0x40U, .spie_mask = 0x80U, .mstr_mask = 0x10U, .spif_mask = 0x80U, .wcol_mask = 0x40U, .sp2x_mask = 0x1U },
    .twi = { .twbr_address = 0x0U, .twsr_address = 0x0U, .twar_address = 0x0U, .twdr_address = 0x0U, .twcr_address = 0x0U, .twamr_address = 0x0U, .vector_index = 26U, .twint_mask = 0x80U, .twen_mask = 0x4U, .twie_mask = 0x1U, .twsto_mask = 0x10U, .twsta_mask = 0x20U, .twea_mask = 0x40U },
