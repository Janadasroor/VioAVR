...
inline constexpr DeviceDescriptor atmega328pb {
    ...
    .adcs = {{ {
            ...
            .didr0_address = 0x7EU,
            .adc_pin_address = {{ 0x26U, 0x26U, 0x26U, 0x26U, 0x26U, 0x26U, 0x2CU, 0x2CU, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U, 0x0U }},
    ...
    .uarts = {{ {
        ...
        },
        {
            ...
            .uart_index = 1U,
            .txd_pin_address = 0x25U, .txd_pin_bit = 3U,
            .rxd_pin_address = 0x23U, .rxd_pin_bit = 4U
        } }},
    ...
    .spi_count = 2U,
    .spis = {{ {
            .spcr_address = 0x4CU, .spsr_address = 0x4DU, .spdr_address = 0x0U,
    ...
    .cfd_count = 1U,
    .cfds = {{ { .xfdcsr_address = 0x62U, .vector_index = 36U } }},

    .fuse_address = 0x0U,
    .lockbit_address = 0x0U,
    .signature_address = 0x0U,

    .signature = { 0x1EU, 0x95U, 0x16U },
    .fuses = { 0x62U, 0xD9U, 0xF7U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU },
    .lockbit_reset = 0xFFU,
