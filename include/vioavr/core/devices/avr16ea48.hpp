...
inline constexpr DeviceDescriptor avr16ea48 {
    .name = "AVR16EA48",
    .flash_words = 6144U,
    .sram_bytes = 2048U,
    .sram_start = 0x7800U,
    ...
    .mapped_user_signatures = { 0x1080U, 0x0040U },
    ...
    .adceas = {{
        {
            ...
            .error_vector_index = 23U,
            .resrdy_vector_index = 24U,
            .samprdy_vector_index = 25U,
        }
    }},
    ...
    .timers_tca = {{
        ...
        },
        {
            ...
            .ctrlc_address = 0xA42U,
            .ctrld_address = 0xA43U,
            .ctrleclr_address = 0xA44U,
            .ctrleset_address = 0xA45U,
            .ctrlfclr_address = 0xA46U,
            .ctrlfset_address = 0xA47U,
            .evctrl_address = 0xA49U,
            .intctrl_address = 0xA4AU,
            .intflags_address = 0xA4BU,
            .dbgctrl_address = 0xA4EU,
            .temp_address = 0xA4FU,
            .tcnt_address = 0xA60U,
            .period_address = 0xA66U,
            .cmp0_address = 0xA68U,
            .cmp1_address = 0xA6AU,
            .cmp2_address = 0xA6CU,
            .perbuf_address = 0xA76U,
            .cmp0buf_address = 0xA78U,
            .cmp1buf_address = 0xA7AU,
            .cmp2buf_address = 0xA7CU,
            .luf_ovf_vector_index = 38U,
            .cmp0_vector_index = 40U,
            .cmp1_vector_index = 41U,
            .cmp2_vector_index = 42U,
            .hunf_vector_index = 39U,
        }
    }},
...
,
        { "PORTE", 0x488U, 0x480U, 0x484U,
          0x481U, 0x482U, 0x483U, 0x485U, 0x486U, 0x487U,
          0x00U, 0x489U, 0x0010U, 255U }
,
