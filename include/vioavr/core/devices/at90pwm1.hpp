...
inline constexpr DeviceDescriptor at90pwm1 {
    ...
    .pscs = {{ {
        ...
        {
            .pctl_address = 0xEBU, .psoc_address = 0xE0U, .pconf_address = 0x0U, .pim_address = 0x0U, .pifr_address = 0x0U, .picr_address = 0xEEU,
            ...
            .prun_mask = 0x1U, .mode_mask = 0x0U, .clksel_mask = 0x0U,
            .ec_flag_mask = 0x0U, .capt_flag_mask = 0x0U,
