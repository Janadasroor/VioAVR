...
inline constexpr DeviceDescriptor atmega649p {
    .name = "ATmega649P",
    .flash_words = 32768U, .sram_bytes = 4096U, .eeprom_bytes = 2048U,
    .interrupt_vector_count = 23U, .interrupt_vector_size = 4U, .flash_page_size = 0x100U,
    ...
    .pradc_bit = 0U, .prusart0_bit = 1U, .prspi_bit = 2U, .prtwi_bit = 255U, .prtimer0_bit = 255U, .prtimer1_bit = 3U, .prtimer2_bit = 255U,
    ...
    .spi = { .spcr_address = 0x4CU, .spsr_address = 0x4DU, .spdr_address = 0x4EU, .spcr_reset = 0x0U, .spsr_reset = 0x0U, .vector_index = 12U, .spe_mask = 0x40U, .spie_mask = 0x80U, .mstr_mask = 0x10U, .spif_mask = 0x80U, .wcol_mask = 0x40U, .sp2x_mask = 0x1U },
