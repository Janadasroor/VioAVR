...
static constexpr DocEntry DOCS[] = {
    ...
    },
    {
        ...
        "\n"
        "5) C API (include/vioavr/c_api.h — viospice_c.h is a compat shim)\n"
        "   Error: VioAvrError return codes + vioavr_get_last_error()\n"
        "   Lifecycle: vioavr_create/destroy/load_hex/load_hex_data/reset\n"
        "   CPU introspection: PC, SREG, SP, cycles, state (running/sleeping/halted)\n"
        "   Memory: vioavr_read_data/write_data (data-space)\n"
        "   Pins: set/get/external, add_mapping, consume_pin_changes, analog I/O\n"
        "   UART: inject_rx, has_tx_byte/read_tx_byte, can_inject_rx\n"
        "   HC-05: enable, has_tx_byte/read_tx_byte, inject_data, pty_fd, ircom\n"
        "   Execution: set_quantum, step_duration, enable_jit, tick_timer2_async\n"
        "   Version: vioavr_get_api_version()\n"
    },
    {
        "co-sim-tests",
